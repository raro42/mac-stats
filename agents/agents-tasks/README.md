...
Log findings (`log-NNN`) and legacy manual tasks (`task-NNN`). New scanner output goes here.

**Scanner:** [../log-monitor/](../log-monitor/) + `python3 scripts/scan_debug_log_errors.py`  
**Log path:** `~/.mac-stats/debug.log` (do not truncate)
