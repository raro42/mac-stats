...
### Added
- CPU metrics **click-to-copy value** — click (or Enter/Space) a ring value (CPU %, GPU %, frequency, temperature) to copy; Copied flash stays on the card so live refresh can keep updating the number (Top Processes / Monitors parity on the metrics surface).
