...
### Added
- **005-openclaw-reviewer** — Workspace doc cross-checking sibling `../openclaw` `AGENTS.md` vs scripts, Vitest thresholds, and `src/` layout (2026-03-22 verification). (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
