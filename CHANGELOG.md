...
- **005-openclaw-reviewer** — Re-verification that sibling `../openclaw` `AGENTS.md` matches `package.json`, Vitest thresholds, and `src/` after upstream doc fixes (2026-03-22). (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
