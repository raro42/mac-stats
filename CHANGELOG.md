...
### Changed
- **Agent Ops Sessions / Knowledge empty meta** — When last activity, file age, kind, or source hint is missing, Sessions, Knowledge, and Overview rows say **Unknown** (not a blank). Real ages and labels still show when set.
...
### Changed
- **Agent Ops health unloaded status** — When Version, Next schedule, Last delivery, or Digest have no payload yet, the health card says **Unknown** (not `—`). Empty jobs still say None yet; real values still show when data exists.
...
### Fixed
- **Sparkline history on open** — CPU, GPU, frequency, and temperature charts now draw the last five minutes from the saved history when you open the window. They no longer start empty and grow from the right.
...
### Changed
- **Futuristic theme sidebar icon status soft parity** — Futuristic section icon good / warning / bad washes match apple Ready calm / Monitors Slow·Down (ok 7%/28%, warn·bad 7%/30%). Louder ~12%/28% tint removed.
...
### Changed
- **Architect theme sidebar icon status soft parity** — Architect section icon good / warning / bad washes match apple Ready calm / Monitors Slow·Down (ok 7%/28%, warn·bad 7%/30%). Louder ~10%/22% tint removed.

## [0.1.1152] - 2026-09-18

### Changed
- **Neon theme sidebar icon status soft parity** — Neon section icon good / warning / bad washes match apple Ready calm / Monitors Slow·Down (ok 7%/28%, warn·bad 7%/30%). Louder ~12%/28% tint removed.

## [0.1.1151] - 2026-09-18

### Changed
- **Dark theme sidebar icon status soft parity** — Dark section icon good / warning / bad washes match apple Ready calm / Monitors Slow·Down (ok 7%/28%, warn·bad 7%/30%). Louder ~12%/28% tint removed.
...
### Changed
- **Material sidebar icon status soft parity** — Material section icon good / warning / bad washes match apple Ready calm / Monitors Slow·Down (ok 7%/28%, warn·bad 7%/30%). Louder ~10%/22% tint removed.

## [0.1.1148] - 2026-09-18

### Changed
- **Swiss-minimalistic sidebar icon status soft parity** — Swiss-minimalistic section icon good / warning / bad washes match apple Ready calm / Monitors Slow·Down (ok 7%/28%, warn·bad 7%/30%). Louder ~10%/22% tint removed.
...
### Changed
- **Perplexity empty-error soft parity** — Perplexity empty-error pane uses the same soft alert as Monitors Down / Perplexity has-error (7% fill, 30% border). Louder 8%/35% tint removed.

## [0.1.1142] - 2026-09-18

### Changed
- **AI Chat error-bubble soft parity** — Assistant error message bubbles use the same soft alert as Errors glance / Monitors Down (7% fill, 30% border). Louder 8%/28% tint removed.
...
### Changed
- **Disk Cleanup Big list-row soft parity** — Big reclaim list rows use the same soft alert as Big attention / Monitors Slow (7% fill, 30% border). Louder 8%/34% tint removed.
...
### Changed
- **AI Chat Errors / last-answer has-errors soft parity** — AI Chat Errors glance and last-answer has-errors wash use the same soft alert as Monitors Down / Debug Log (7% fill, 30% border). Louder 8%/34% tint removed.

## [0.1.1137] - 2026-09-17

### Changed
- **Debug Log has-errors soft parity** — Debug Log Error attention glance and collapsed error glance use the same soft alert wash as Monitors Down (7% fill, 30% border). Louder 8%/34% tint removed.
...
### Changed
- **Ops Discord Offline/Reconnect soft parity** — Agent Ops Discord Offline / Reconnect attention glances use the same soft alert wash as Monitors Down / Slow (7% fill, 30% border). Louder 8%/34% tint removed.
...
### Changed
- **Disk Cleanup periodic-off soft parity** — Runs when meta-card (periodic cleanup off) uses the same soft accent wash as Ops Off / Files / Deliveries / Discord (7% fill, 28% border). Louder 8%/34% cyan tint removed; Enabled scopes-off already matched soft alert.
...
### Changed
- **Processes Hot attention soft parity** — Top Processes **Hot · N hot** attention glance uses the same soft alert wash as Monitors Slow (7% fill, 30% border). Louder 8%/34% tint removed; Hot filter chip wash stays as it is.

## [0.1.1119] - 2026-09-17

### Changed
- **Disk Cleanup Big filter attention soft parity** — Disk · Big filter attention glance uses the same soft alert wash as Monitors Slow (7% fill, 30% border). Louder 8%/34% tint removed; Reclaim stays slightly softer; Clean stays green.
...
### Changed
- **Ops accent filter attention soft parity** — Agent Ops Off / Files / Deliveries / Discord filter attention glances use the same soft accent wash as Ready / `.is-filter` (7% fill, 28% border). Louder 8%/34% tint removed; Fail / Slow stay stronger.
...
### Changed
- **Debug Log collapsed glance calm** — when the tail has no ERROR/WARN (`Quiet · clean`), the collapsed Debug Log glance uses a soft green wash (Monitors all-up / Disk is-clean / Details is-ok parity). Errors still red; warns-only still amber.
...
### Changed
- **Top Processes filter-miss calm** — Hot/Pinned empty panes use a warm “Nothing here yet” title and solid wash (Hot empty soft green — nothing hot is good news; Pinned accent). Matches AI Chat / Agent Ops filter-miss calm.
...
### Changed
- **Disk Cleanup Add scope** — the control is a full pressable button (padding, border, hover, press) instead of a tiny unstyled control beside the path fields.
...
- Instant lane: `/keep-p25` · `keep p25` · `p25 keep gap` · `25th percentile keep gap` · `p25 gap between keeps` · `view keep p25` / `open keep p25` (and discard variants) — p25 (floor quartile) gap between consecutive keep or discard rows from `results.tsv` (tonight since 20:00 + all-time; p25 only; no row dump). Does not steal `/keep-pace` average, `/keep-median` median, `/keep-range` min–max, `/keep-p90` p90, `/keep-p95` p95, `/keep-p10` p10, `/keep-iqr` IQR, `/keep-std` std, `/keep-mad` MAD, `/keep-cv` CV, `/keep-skew` skewness, `/keep-kurtosis` excess kurtosis, `/keep-entropy` Shannon entropy, `/keep-mode` modal gap, `/keep-gini` Gini, `/keep-histogram` histogram, `/first-keep` / `/last-keep` / `/since-keep` / counts / rate / streak / recent / path/size/age / morning-surprise. Digester Slowest filters for ratchet glances. Hermes-style ratchet glance; p50.

## [0.1.1071] - 2026-09-14

### Added

- Instant lane: `/keep-p10` · `keep p10` · `p10 keep gap` · `10th percentile keep gap` · `p10 gap between keeps` · `view keep p10` / `open keep p10` (and discard variants) — p10 gap between consecutive keep or discard rows from `results.tsv` (tonight since 20:00 + all-time; p10 only; no row dump). Does not steal `/keep-pace` average, `/keep-median` median, `/keep-range` min–max, `/keep-p90` p90, `/keep-p95` p95, `/keep-iqr` IQR, `/keep-std` std, `/keep-mad` MAD, `/keep-cv` CV, `/keep-skew` skewness, `/keep-kurtosis` excess kurtosis, `/keep-entropy` Shannon entropy, `/keep-mode` modal gap, `/keep-gini` Gini, `/keep-histogram` histogram, `/first-keep` / `/last-keep` / `/since-keep` / counts / rate / streak / recent / path/size/age / morning-surprise. Digester Slowest filters for ratchet glances. Hermes-style ratchet glance; p50.

## [0.1.1070] - 2026-09-14

### Added

- Instant lane: `/keep-p95` · `keep p95` · `p95 keep gap` · `95th percentile keep gap` · `p95 gap between keeps` · `view keep p95` / `open keep p95` (and discard variants) — p95 gap between consecutive keep or discard rows from `results.tsv` (tonight since 20:00 + all-time; p95 only; no row dump). Does not steal `/keep-pace` average, `/keep-median` median, `/keep-range` min–max, `/keep-p90` p90, `/keep-iqr` IQR, `/keep-std` std, `/keep-mad` MAD, `/keep-cv` CV, `/keep-skew` skewness, `/keep-kurtosis` excess kurtosis, `/keep-entropy` Shannon entropy, `/keep-mode` modal gap, `/keep-gini` Gini, `/keep-histogram` histogram, `/first-keep` / `/last-keep` / `/since-keep` / counts / rate / streak / recent / path/size/age / morning-surprise. Digester Slowest filters for ratchet glances. Hermes-style ratchet glance; p50.

## [0.1.1069] - 2026-09-14

### Added

- Instant lane: `/keep-histogram` · `keep histogram` · `gap histogram` · `keep gap histogram` · `histogram keep gap` · `view keep histogram` / `open keep histogram` (and discard / hist variants) — minute-bucket histogram (`<5m` · `5–10m` · `10–20m` · `20–30m` · `30–60m` · `≥60m`) of gaps between consecutive keep or discard rows from `results.tsv` (tonight since 20:00 + all-time; histogram only; no row dump). Does not steal `/keep-pace` average, `/keep-median` median, `/keep-range` min–max, `/keep-p90` p90, `/keep-iqr` IQR, `/keep-std` std, `/keep-mad` MAD, `/keep-cv` CV, `/keep-skew` skewness, `/keep-kurtosis` excess kurtosis, `/keep-entropy` Shannon entropy, `/keep-mode` modal gap, `/keep-gini` Gini, `/first-keep` / `/last-keep` / `/since-keep` / counts / rate / streak / recent / path/size/age / morning-surprise. Digester Slowest filters for ratchet glances. Hermes-style ratchet glance; p50.

## [0.1.1068] - 2026-09-14

### Added

- Instant lane: `/keep-gini` · `keep gini` · `gini keep gap` · `gini coefficient keep gap` · `gini gap between keeps` · `view keep gini` / `open keep gini` (and discard / Gini variants) — Gini coefficient (0–1) of gap lengths between consecutive keep or discard rows from `results.tsv` (tonight since 20:00 + all-time; Gini only; no row dump). Does not steal `/keep-pace` average, `/keep-median` median, `/keep-range` min–max, `/keep-p90` p90, `/keep-iqr` IQR, `/keep-std` std, `/keep-mad` MAD, `/keep-cv` CV, `/keep-skew` skewness, `/keep-kurtosis` excess kurtosis, `/keep-entropy` Shannon entropy, `/keep-mode` modal gap, `/first-keep` / `/last-keep` / `/since-keep` / counts / rate / streak / recent / path/size/age / morning-surprise. Digester Slowest filters for ratchet glances. Hermes-style ratchet glance; p50.
...
- Instant lane: `/keep-mode` · `keep mode` · `mode keep gap` · `modal keep gap` · `mode gap between keeps` · `view keep mode` / `open keep mode` (and discard / modal variants) — modal (most frequent minute-bucketed) gap between consecutive keep or discard rows from `results.tsv` (tonight since 20:00 + all-time; mode only; no row dump). Does not steal `/keep-pace` average, `/keep-median` median, `/keep-range` min–max, `/keep-p90` p90, `/keep-iqr` IQR, `/keep-std` std, `/keep-mad` MAD, `/keep-cv` CV, `/keep-skew` skewness, `/keep-kurtosis` excess kurtosis, `/keep-entropy` Shannon entropy, `/first-keep` / `/last-keep` / `/since-keep` / counts / rate / streak / recent / path/size/age / morning-surprise. Digester Slowest filters for ratchet glances. Hermes-style ratchet glance; p50.

## [0.1.1065] - 2026-09-14

### Added
- Instant lane: `/keep-entropy` · `keep entropy` · `entropy keep gap` · `shannon entropy keep gap` · `entropy gap between keeps` · `view keep entropy` / `open keep entropy` (and discard / shannon variants) — Shannon entropy (bits) of minute-bucketed gaps between consecutive keep or discard rows from `results.tsv` (tonight since 20:00 + all-time; entropy only; no row dump). Does not steal `/keep-pace` average, `/keep-median` median, `/keep-range` min–max, `/keep-p90` p90, `/keep-iqr` IQR, `/keep-std` std, `/keep-mad` MAD, `/keep-cv` CV, `/keep-skew` skewness, `/keep-kurtosis` excess kurtosis, `/first-keep` / `/last-keep` / `/since-keep` / counts / rate / streak / recent / path/size/age / morning-surprise. Digester Slowest filters for ratchet glances. Hermes-style ratchet glance; p50.

## [0.1.1064] - 2026-09-14

### Added
- Instant lane: `/keep-kurtosis` · `keep kurtosis` · `kurtosis keep gap` · `excess kurtosis keep gap` · `kurtosis gap between keeps` · `view keep kurtosis` / `open keep kurtosis` (and discard / kurt variants) — excess kurtosis (Fisher G2) of gaps between consecutive keep or discard rows from `results.tsv` (tonight since 20:00 + all-time; kurtosis only; no row dump). Does not steal `/keep-pace` average, `/keep-median` median, `/keep-range` min–max, `/keep-p90` p90, `/keep-iqr` IQR, `/keep-std` std, `/keep-mad` MAD, `/keep-cv` CV, `/keep-skew` skewness, `/first-keep` / `/last-keep` / `/since-keep` / counts / rate / streak / recent / path/size/age / morning-surprise. Digester Slowest filters for ratchet glances. Hermes-style ratchet glance; p50.
...
### Added
- Instant lane: `/keep-cv` · `keep cv` · `cv keep gap` · `coefficient of variation keep gap` · `cv gap between keeps` · `view keep cv` / `open keep cv` (and discard / CV variants) — CV (coefficient of variation = sample std / mean, as %) of gaps between consecutive keep or discard rows from `results.tsv` (tonight since 20:00 + all-time; CV only; no row dump). Does not steal `/keep-pace` average, `/keep-median` median, `/keep-range` min–max, `/keep-p90` p90, `/keep-iqr` IQR, `/keep-std` std, `/keep-mad` MAD, `/first-keep` / `/last-keep` / `/since-keep` / counts / rate / streak / recent / path/size/age / morning-surprise. Digester Slowest filters for ratchet glances. Hermes-style ratchet glance; p50.

## [0.1.1061] - 2026-09-14

### Added
- Instant lane: `/keep-mad` · `keep mad` · `mad keep gap` · `median absolute deviation keep gap` · `mad gap between keeps` · `view keep mad` / `open keep mad` (and discard / MAD variants) — MAD (median absolute deviation) of gaps between consecutive keep or discard rows from `results.tsv` (tonight since 20:00 + all-time; MAD only; no row dump). Does not steal `/keep-pace` average, `/keep-median` median, `/keep-range` min–max, `/keep-p90` p90, `/keep-iqr` IQR, `/keep-std` std, `/first-keep` / `/last-keep` / `/since-keep` / counts / rate / streak / recent / path/size/age / morning-surprise. Digester Slowest filters for ratchet glances. Hermes-style ratchet glance; p50.
...
### Added
- Instant lane: `/keep-iqr` · `keep iqr` · `iqr keep gap` · `interquartile keep gap` · `iqr gap between keeps` · `view keep iqr` / `open keep iqr` (and discard / interquartile variants) — IQR (Q3−Q1) gap between consecutive keep or discard rows from `results.tsv` (tonight since 20:00 + all-time; IQR only; no row dump). Does not steal `/keep-pace` average, `/keep-median` median, `/keep-range` min–max, `/keep-p90` p90, `/first-keep` / `/last-keep` / `/since-keep` / counts / rate / streak / recent / path/size/age / morning-surprise. Digester Slowest filters for ratchet glances. Hermes-style ratchet glance; p50.
...
### Added
- Instant lane: `/keep-range` · `keep range` · `keep gap range` · `min max keep gap` · `shortest and longest keep gap` · `view keep range` / `open keep range` (and discard / spread variants) — min–max gap between consecutive keep or discard rows from `results.tsv` (tonight since 20:00 + all-time; range only; no row dump). Does not steal `/keep-pace` average, `/keep-median` median, `/first-keep` / `/last-keep` / `/since-keep` / counts / rate / streak / recent / path/size/age / morning-surprise. Digester Slowest filters for ratchet glances. Hermes-style ratchet glance; p50.
...
### Added
- Instant lane: `/keep-pace` · `keep pace` · `keep gap` · `time between keeps` · `average keep gap` · `average time between keeps` · `view keep pace` / `open keep pace` (and discard / gap variants) — average gap between consecutive keep or discard rows from `results.tsv` (tonight since 20:00 + all-time; pace only; no row dump). Does not steal `/first-keep` / `/last-keep` / `/since-keep` / counts / rate / streak / recent / path/size/age / morning-surprise. Digester Slowest filters for ratchet glances. Hermes-style ratchet glance; p50.
...
### Added
- Instant lane: more Top Processes NL for `/processes` — `view processes`, `see processes`, `show me the processes`, `open processes`, `list the processes` (and close variants) join `top processes` / `show processes` / Hot · Pinned filters.
...
### Added
- Agent Ops Agents: Clear chip beside All · On · Off when an enabled filter is active (Sessions / Processes / Disk Clear parity) — flashes Cleared, then returns to All; filter-miss Clear filter CTA uses the same flash when On/Off was on.

## [0.1.1012] - 2026-09-11

### Added
- Agent Ops Sessions: Clear chip beside All · Live · Files when a kind filter is active (Processes / Disk / Debug Log / Perplexity Clear parity) — flashes Cleared, then returns to All; filter-miss Clear filter CTA uses the same flash when Live/Files was on.
...
### Added
- Instant lane: launchd stderr age (`launchd stderr age`, `how old is launchd.stderr.log`, `launchd.stderr.log age`, `mac-stats launchd stderr age`, `when was launchd stderr updated`) — `~/.mac-stats/launchd.stderr.log` last write age (mtime; no dump/tail; does not steal path / size / harness loop stderr / LaunchAgent plist / `debug.log age` / morning surprise / improvements / loop backlog / sibling / standing).
...
### Added
- Instant lane: harness loop stderr size (`harness loop stderr size`, `how big is overnight_harness_loop.stderr.log`, `overnight_harness_loop.stderr.log size`, `harness stderr size`) — `~/.mac-stats/improvements/overnight_harness_loop.stderr.log` size on disk (stat only; no dump/tail; does not steal path / age / overnight_agent.log / stdout / `debug.log size` / morning surprise / improvements / loop backlog / sibling / standing).
...
### Changed
- External / Monitors: Clear chip beside All · Up · Down · Slow when a filter is active (Top Processes / AI Chat / Ops Clear parity) — flashes Cleared, then returns to All; empty filter-miss Clear uses the same flash.
...
### Added
- Instant lane: harness loop stdout age (`harness loop stdout age`, `how old is overnight_harness_loop.stdout.log`, `overnight_harness_loop.stdout.log age`, `harness stdout age`, `when was harness loop stdout updated`) — `~/.mac-stats/improvements/overnight_harness_loop.stdout.log` last write age (mtime; no dump/tail; does not steal path / size / overnight_agent.log / stderr / `debug.log age` / morning surprise / improvements / loop backlog / sibling / standing).
...
### Added
- Instant lane: harness loop stdout path (`harness loop stdout path`, `where is overnight_harness_loop.stdout.log`, `overnight_harness_loop.stdout.log path`, `harness stdout path`) — `~/.mac-stats/improvements/overnight_harness_loop.stdout.log` path only; no dump/tail; does not steal overnight_agent.log / stderr / `debug.log path` / morning surprise / improvements / loop backlog / sibling / standing.
...
### Added
- Instant lane: standing_backlog.md path (`standing backlog path`, `where is standing_backlog.md`, `overnight standing backlog path`, `track b backlog path`) — path only; no dump; does not steal `improvements path` / `loop backlog path` / `sibling harness path`.
...
### Added
- Instant lane: browser_storage_state.json age (`storage state age`, `browser_storage_state.json age`, `how old are browser cookies`, `when was storage state updated`, `cdp cookies age`) — file mtime only; no dump; does not steal path / size / cookie reject / browser credentials.
...
### Added
- Instant lane: downloads-organizer-state.json age (`organizer state age`, `downloads organizer state age`, `how old is downloads organizer state`, `when was downloads organizer state updated`, `downloads-organizer-state.json age`) — file mtime only; no dump; does not steal path / size / organizer rules / `/downloads`.
...
### Added
- Instant lane: uploads directory age (`uploads age`, `how old are uploads`, `uploads folder age`, `when was uploads updated`) — newest file mtime under `~/.mac-stats/uploads/`; no list dump; does not steal path / size / upload.
...
- **Instant lane: before-compaction transcript age** — `before compaction transcript age`, `before-compaction transcript age`, `how old is before compaction transcript`, `when was before compaction transcript updated`, `last_session_before_compaction.jsonl age`, and close variants return the transcript file mtime without Ollama (Discord + AI Chat; no dump/hook; does not steal `before compaction transcript path` / size / before-reset / session reset phrases; p50 latency).
...
- **Instant lane: credential_accounts.json age** — `credential accounts age`, `credential_accounts.json age`, `how old is credential accounts`, `when was credential accounts updated`, and close variants return the last-write age of `credential_accounts.json` without Ollama (Discord + AI Chat; mtime only — no dump; does not steal `credential accounts path` / `credential accounts size` / browser credentials; p50 latency).
...
- **Instant lane: downloads-organizer-state.json size** — `organizer state size`, `downloads-organizer-state.json size`, `how big is downloads organizer state`, `downloads organizer state size`, and close variants return on-disk size of the downloads organizer state file without Ollama (Discord + AI Chat; stat only — no dump; does not steal `downloads organizer state path` / rules / `/downloads`; p50 latency).
...
- **Instant lane: mood.md size** — `mood size`, `mood.md size`, `how big is mood`, `mood file size`, and close variants return on-disk size of per-agent `mood.md` files without Ollama (Discord + AI Chat; stat only — no dump; does not steal `mood path` / soul / agents; p50 latency).
...
- **Instant lane: history.json size** — `history size`, `history.json size`, `how big is history`, `metrics history size`, and close variants return on-disk size of `history.json` without Ollama (Discord + AI Chat; stat only — no dump/sparkline/chat history; does not steal `history path`; p50 latency).
...
- **Instant lane: cleanup-quarantine directory size** — `cleanup quarantine size`, `how big is quarantine`, `quarantine folder size`, and similar asks return recursive on-disk size under `~/.mac-stats/cleanup-quarantine/` without Ollama (Discord + AI Chat; file-byte sum only — no list dump; does not steal `cleanup quarantine path` / `/disk` Clean now / list/prune/restore; p50 latency).
...
- **Instant lane: session directory size** — `session size`, `how big are sessions`, `session folder size`, and similar asks return recursive on-disk size under `~/.mac-stats/session/` without Ollama (Discord + AI Chat; file-byte sum only — no list dump; does not steal `session path` / `/sessions` Live/Files / session-memory path; p50 latency).
...
- **Instant lane: plugins/scripts directory size** — `plugins size`, `scripts size`, `how big are plugins`, `plugins folder size`, and similar asks return recursive on-disk size under `~/.mac-stats/scripts/` without Ollama (Discord + AI Chat; file-byte sum only — no list dump; does not steal `plugins path` / `/plugins` On/Off / run; p50 latency).
...
- **Instant lane: agents directory size** — `agents size`, `how big are agents`, `agents folder size`, and similar asks return recursive on-disk size under `~/.mac-stats/agents/` without Ollama (Discord + AI Chat; file-byte sum only — no list dump; does not steal `agents path` / `/agents` On/Off / agent.json; p50 latency).

## [0.1.879] - 2026-09-05

### Added

- **Instant lane: browser-downloads directory size** — `browser downloads size`, `how big are browser downloads`, `browser-downloads size`, and similar asks return recursive on-disk size under `~/.mac-stats/browser-downloads/` without Ollama (Discord + AI Chat; file-byte sum only — no list dump; does not steal `browser downloads path` / `/downloads` organizer / download-now; p50 latency).

## [0.1.878] - 2026-09-05

### Added

- **Instant lane: PDF exports directory size** — `pdfs size`, `how big are pdfs`, `pdfs folder size`, and similar asks return recursive on-disk size under `~/.mac-stats/pdfs/` without Ollama (Discord + AI Chat; file-byte sum only — no list dump; does not steal `pdfs path` / save/list; p50 latency).
...
- **Instant lane: uploads directory size** — `uploads size`, `how big are uploads`, `uploads folder size`, and similar asks return recursive on-disk size under `~/.mac-stats/uploads/` without Ollama (Discord + AI Chat; file-byte sum only — no list dump; does not steal `uploads path` / upload/list; p50 latency).

## [0.1.875] - 2026-09-05

### Added

- **Instant lane: tmp directory size** — `tmp size`, `how big is tmp`, `tmp folder size`, and similar asks return recursive on-disk size under `~/.mac-stats/tmp/` without Ollama (Discord + AI Chat; file-byte sum only — no list dump; does not steal `tmp path` / prune/clean / temperature; p50 latency).

## [0.1.874] - 2026-09-05

### Added

- **Instant lane: screenshots directory size** — `screenshots size`, `how big are screenshots`, `screenshots folder size`, and similar asks return recursive on-disk size under the BROWSER_SCREENSHOT save dir without Ollama (Discord + AI Chat; file-byte sum only — no list dump; does not steal `screenshot path` / take/list/prune; p50 latency).
...
- **Instant lane: digest file size** — `digest size`, `how big is the digest`, `latest.json size`, and similar asks return on-disk size from digester `latest.json` metadata without Ollama (Discord + AI Chat; stat only — no digester spawn / open dump; does not steal `digest age` / `digest open` / `/digest` refresh; p50 latency).
...
### Fixed
- **Instant lane: soul.md path** — `soul path`, `where is soul.md`, `soul file path`, and similar asks return `~/.mac-stats/agents/soul.md` without Ollama (Discord + AI Chat; path only — does not dump or edit soul text; does not steal `/agents` / agents dir / memory / mood path; p50 latency).
...
### Fixed
- **Instant lane: downloads-organizer-rules.md path** — `downloads organizer rules path`, `where is downloads-organizer-rules.md`, `organizer rules path`, and similar asks return `~/.mac-stats/agents/downloads-organizer-rules.md` without Ollama (Discord + AI Chat; path only — does not list rules or run organize-now; does not steal `/downloads` Ready / browser-downloads / agents path; p50 latency).
...
### Fixed
- **Instant lane: credential_accounts.json path** — `credential accounts path`, `where is credential_accounts.json`, `keychain accounts path`, and similar asks return `~/.mac-stats/credential_accounts.json` without Ollama (Discord + AI Chat; path only — does not list Keychain accounts or dump secrets; does not steal browser credentials / `browser-credentials.toml`; p50 latency).
...
### Fixed
- **Instant lane: improvements directory path** — `improvements path`, `where is the improvements folder`, `autoresearch path`, and similar asks return `~/.mac-stats/improvements/` without Ollama (Discord + AI Chat; does not list digests or open morning surprise; does not steal overnight “any improvements…” content asks; p50 latency).
...
### Fixed
- **Instant lane: monitors.json path** — `monitors path`, `where is monitors.json`, `monitor file path`, and similar asks return `~/.mac-stats/monitors.json` without Ollama (Discord + AI Chat; does not list, add, or check sites; does not steal `/monitors`; p50 latency).
...
### Fixed
- **Instant lane: browser credentials path** — `browser credentials path`, `where are browser credentials`, `browser-credentials.toml`, and similar asks return `~/.mac-stats/browser-credentials.toml` without Ollama (Discord + AI Chat; does not list or edit secrets; p50 latency).
...
### Fixed
- **Instant lane: uploads directory path** — `uploads path`, `where is the uploads folder`, `upload directory`, and similar asks return `~/.mac-stats/uploads/` without Ollama (Discord + AI Chat; does not list or upload; p50 latency).
...
### Fixed
- **Instant lane: prompts directory path** — `prompts path`, `where is the prompts folder`, `prompts directory`, and similar asks return `~/.mac-stats/agents/prompts/` without Ollama (Discord + AI Chat; does not open or edit; p50 latency).
...
### Fixed
- **Instant lane: agents directory path** — `agents path`, `where is the agents folder`, `agents directory`, and similar asks return `~/.mac-stats/agents/` without Ollama (Discord + AI Chat; does not list or create; p50 latency).

## [0.1.816] - 2026-09-02

### Fixed
- **Instant lane: session directory path** — `session path`, `where is the session folder`, `session directory`, and similar asks return `~/.mac-stats/session/` without Ollama (Discord + AI Chat; does not list or resume; p50 latency).
...
### Fixed
- **Instant lane: runs.jsonl path** — `runs path`, `where is runs.jsonl`, `runs file path`, and similar asks return `~/.mac-stats/runs.jsonl` without Ollama (Discord + AI Chat; does not list, count, or prune; p50 latency).
...
### Added
- **Agent Ops Cursor health attention glance** — When `get_feature_health` reports Cursor agent Not set, Agent Ops shows an amber **Cursor · Not set · add binary path** strip under MCP. Click opens Settings Credentials and focuses the Cursor binary path field. Adds config-only Cursor probe to feature-health (PATH / Settings path; `/cursor` parity). Design review / `feature-agent-ops`.

## [0.1.793] - 2026-09-01

### Added
- **Agent Ops MCP health attention glance** — When `get_feature_health` reports MCP Not set, Agent Ops shows an amber **MCP · Not set · add URL or stdio** strip under Browser. Click opens Settings Credentials and focuses the MCP URL field. Adds config-only MCP to feature-health probes (no live `tools/list`; `/mcp` parity). Design review / `feature-agent-ops`.
...
### Added
- **Agent Ops Brave health attention glance** — When `get_feature_health` reports Brave Search Not set or Unavailable, Agent Ops shows an amber/red **Brave · …** strip under Ollama/Redmine. Click opens Settings Credentials and focuses the Brave API key field. Design review / `feature-agent-ops`.

## [0.1.790] - 2026-09-01

### Added
- **Agent Ops Ollama health attention glance** — When `get_feature_health` reports Ollama Not set, Offline, or Degraded, Agent Ops shows an amber/red **Ollama · …** strip under Redmine/Discord (distinct from AI Chat live circuit state). Not set/Offline opens the Ollama URL dialog; Degraded opens AI Chat model picker. Design review / `feature-agent-ops`.
...
### Added
- **Settings Redmine URL + API key** — Credentials now has Save / Clear for Redmine (Keychain `redmine_url` / `redmine_api_key`, same resolve order as env / `.config.env`). When not fully set, a **Redmine · Not set / Partial** red strip appears above the controls (Brave / Perplexity / Discord parity). Click focuses the missing field. `/redmine` Not-set cue mentions Settings.
...
### Changed
- **CPU window scroll** — sections below the gauges (processes, chat, logs, and the rest) grow to full height. Scroll the outer shell once instead of each section on its own.
...
### Added
- **`/ai` · `/ai-agent` instant operator** — AI On / Off chip (`aiAgentEnabled`; config only, does not toggle; Discord + AI Chat; does not steal `/agents` catalog or enable/disable / chat-with-AI asks).
...
### Added
- **`/plugins` · `/plugins on` · `/plugins off` instant operator** — registered script plugins On/Off list (Discord + AI Chat; Agents On/Off parity; no script run; does not steal add/run/remove or “search for tauri plugins”).
...
### Added
- **`/sessions` instant operator** — `/sessions`, `/sessions live`, `/sessions files` and NL (`list sessions`, `live sessions`, `session files`, `saved sessions`) list live in-memory sessions and saved session files (Discord + AI Chat; Agent Ops Sessions Live/Files filter parity).
...
### Fixed
- **CPU window blank gauges** — syntax error in Perplexity results keyboard handler (missing `}` before PageDown) stopped `cpu.js` from loading, so rings and values never updated.
...
### Added
- **Monitors collapsed glance↔icon↔footer toolbar chain** — Monitors icon ↓ → collapsed glance when the section is collapsed; glance ↑ → icon · ↓ → footer; footer ↑ → glance when Monitors is collapsed.
...
### Added
- **Perplexity icon-line↔setup toolbar chain** — Perplexity icon ↓ → inline API-key field when the setup panel is open; key first ↑ → Perplexity icon (onboarding keyboard loop).
...
### Added
- **Monitors add-btn↔settings-list toolbar chain** — close ↓ → add-btn; add-btn ↓ → first Remove/empty CTA; add-btn ↑ → close; list first ↑ → add-btn (settings popover header chain).
...
### Added
- **Ollama settings full modal toolbar wrap** — footer version ↔ system-prompt toolbar when the popover is open; prompt first ← crosses to footer version; Save last → footer; footer version ← crosses to Save (filter-chip chain when closed).
...
### Added
- Settings **Credentials↔header toolbar wrap** — at the last Credentials control, ← → / h l crosses into header Close; at the header title, ← crosses back to the last Credentials control (header↔Appearance chain parity).
...
### Added
- Disk Cleanup **action toolbar keyboard** — focus Clean now · Refresh · Save scopes, then ← → / h l / Home / End moves across controls (Debug Log / meta-card parity). Enter / Space keeps button activate. Soft kb hint when two or more controls are visible; one Tab stop via roving tabindex.
...
### Added
- Agent Ops **filter-row toolbar keyboard** — focus search input · N/M match chip · Clear, then ← → / h l / Home / End moves across controls (preview-row / refresh-row parity). Arrows leave the input only at text start/end. Soft kb hint when two or more controls are visible; one Tab stop via roving tabindex.
...
### Added
- CPU metrics **history sparkline toolbar keyboard** — focus CPU · Freq · Temp charts, then ← → / h l / Home / End moves across sparklines (ring-gauge / power-strip parity). Enter / Space / click jumps to the matching ring (scroll + flash). Soft kb hint; one Tab stop via roving tabindex.
...
### Added
- AI Chat **listbox chrome keyboard** — focus the messages list, then ↑↓ / j k / Home / End jumps to the first or last message (Perplexity / Monitors / Debug Log chrome parity). Soft kb hint mentions list focus.
...
### Added
- Menu bar **GPU** cue (amber) when GPU usage is **≥ 15%** — same threshold as the power-strip GPU hot wash. Hidden when below 15%.
...
### Added
- CPU metrics **CPU % on the battery/power strip** (menu-bar parity). Click or Enter/Space scrolls to the CPU ring and flashes it. Soft amber wash when ≥ 50%.
...
### Added
- Top Processes **Top CPU** glance strip under the section header — shows the hottest process and opens its details on click (Monitors slowest-summary parity). Soft amber wash when CPU ≥ 15%.

## [0.1.530] - 2026-08-19

### Added
- External / Monitors summary click opens the **slowest** site when all monitors are up and latency hints are shown (DOWN still opens first DOWN row). Soft amber wash on the summary strip when the slowest hint is active.

## [0.1.529] - 2026-08-19

### Added
- Disk Cleanup **Last run** panel click — opens the first category cleaned in the last run (or reclaimable row / scopes when none yet; meta-card parity). Soft amber wash when files were skipped (Trash move failed).

## [0.1.528] - 2026-08-19

### Added
- Disk Cleanup **Runs when** meta-card click — scrolls to enabled scopes (launch/schedule parity; Enabled scopes prefers off scopes first). Soft blue wash when periodic cleanup is off.

## [0.1.527] - 2026-08-19

### Added
- AI Chat empty-state starter chips show a brief **In composer** flash when clicked (Load into AI Chat / save-button feedback parity; still no auto-send).

## [0.1.526] - 2026-08-19

### Added
- Disk Cleanup **Next automatic run** meta-card click — when due, focuses Clean now; otherwise scrolls to last-run summary (Reclaimable / Enabled scopes parity). Soft green wash when due.

## [0.1.525] - 2026-08-18

### Added
- Disk Cleanup **Enabled scopes** meta-card click — opens scope review (first off scope / Add form; Reclaimable now / Monitors summary parity). Soft wash when some scopes are off.
...
### Added
- Disk Cleanup **empty Review scopes CTA** — when no categories show, warm empty + Review scopes focuses the first off scope (or Add form; Monitors empty Add parity).

## [0.1.522] - 2026-08-18

### Added
- Top Processes **All · Pinned filter chips** — pinned count, star wash, filter-miss Clear (Monitors / Debug Log parity).

## [0.1.521] - 2026-08-18

### Added
- External / Monitors **All · Up · Down filter chips** — counts, status wash, filter-miss Clear (Debug Log filter parity).

## [0.1.520] - 2026-08-18

### Added
- CPU metrics **RAM on the battery/power strip** — shows RAM % next to battery and power (menu-bar parity). Click (or Enter/Space) opens Details and highlights used / total.
...
### Added
- External / Monitors **summary click + empty Add CTA** — click (or Enter/Space) the summary to open the first DOWN site (or first row); empty list shows “Nothing watching yet” with **Add a monitor** (settings Add form; Agent Ops empty-CTA parity).

## [0.1.517] - 2026-08-18

### Added
- Battery / power strip **click-to-copy** — click (or Enter/Space) battery % or power watts to copy; Copied overlay so live refresh can keep updating the number (GPU/GHz/°C parity on the metrics surface).

## [0.1.516] - 2026-08-18

### Fixed
- CPU gauge click again **toggles Details / Top Processes** — overnight click-to-copy on the CPU % value stopped event bubbling and stole that control; copy stays on GPU, frequency, and temperature only.

## [0.1.515] - 2026-08-18

### Added
- Debug Log **Error / Warn filter chips** — All, Error, and Warn in the toolbar (counts + continuation lines); empty filter says nothing is there yet.
...
### Added
- CPU metrics **click-to-copy value** — click (or Enter/Space) a ring value (GPU %, frequency, temperature) to copy; Copied flash stays on the card so live refresh can keep updating the number. (CPU % click later restored to Details / Top Processes in **v0.1.516**.)
...
### Added
- Agent Ops **0 Overview** jump — tab-strip control + digit 0 scrolls health/overview into view after 1–5 detail tabs (accent flash).
...
### Changed
- Agent Ops **Refresh / Updated** row sits under the health strip (not under tab panels) so freshness stays in view with overview.

## [0.1.503] - 2026-08-18

### Added
- Agent Ops **tab inventory counts** — glass count pills on Agents / Sessions / Schedules / Knowledge / Runs after refresh (hover shows count + digit shortcut).
...
### Changed
- Agent Ops **overview cards**: click chrome / empty body (or Enter/Space when focused) opens the linked tab — health-card parity; rows and Open still do their own jobs.

## [0.1.499] - 2026-08-17

### Changed
- Agent Ops **overview Recent** card: ok/warn/bad status wash (health Last delivery age parity) — empty warn; newest <24h ok; newest ≥7d bad; otherwise warn.

## [0.1.498] - 2026-08-17

### Changed
- Agent Ops **overview Knowledge** card: ok/warn/bad status wash (health Version session-file count parity) — empty warn; ≥40 files warn; otherwise ok.

## [0.1.497] - 2026-08-17

### Changed
- Agent Ops **overview Live** card: ok/warn/bad status wash (health Discord gateway parity) — disconnected bad; reconnect noise or empty warn; live + gateway ready ok.

## [0.1.496] - 2026-08-17

### Changed
- Agent Ops **overview Digest** card: ok/warn/bad status wash (health Digest fail/open parity) — missing digest warn; open candidates or fails warn; clear digest ok.

## [0.1.495] - 2026-08-17

### Changed
- Agent Ops **overview Runs** card: ok/warn/bad status wash (health Digest fail/open parity) — empty warn; fails or digester open warn; otherwise ok.
...
### Changed
- Agent Ops **overview Schedules** card: ok/warn/bad status wash (health Next schedule / Last delivery parity) — empty jobs warn; next fire + delivery under 24h ok; delivery a week or older bad.

## [0.1.492] - 2026-08-17

### Changed
- Agent Ops **health Version**: ok/warn/bad status wash (Discord/Redmine/Digest parity) — missing version is bad; zero enabled agents or ≥40 session files warn; otherwise ok.
...
### Added
- Agent Ops **overview Digest** card: digester open-hint snapshot with click-to-preview + Load into AI Chat (health Digest / Runs Insights parity; Runs tab active wash).
...
### Added
- Agent Ops **overview Agents** card: enabled/orchestrator snapshot with click-to-open + Load into AI Chat (Schedules/Live/Knowledge/Recent parity; Agents tab active wash).

## [0.1.487] - 2026-08-17

### Changed
- Agent Ops **health Redmine**: click opens Agents with the Redmine agent selected and soul/skill/mood ready for Load into AI Chat (Version health parity).

## [0.1.486] - 2026-08-17

### Changed
- Agent Ops **health Discord**: click opens Runs with gateway status preview + Load into AI Chat; Runs Insights Discord line is clickable (Digest/Version health parity).
...
### Changed
- Agent Ops **Runs Insights** Digest open hints are clickable — preview + Load into AI Chat; health Digest card opens the first hint (Slowest/Candidates parity).

## [0.1.483] - 2026-08-17

### Changed
- Agent Ops **health** Next schedule / Last delivery: click opens Schedules with matching row selected and preview + Load into AI Chat (overview schedule/delivery parity).

## [0.1.482] - 2026-08-17

### Changed
- Agent Ops **Runs Insights**: Slowest and Candidates lines are clickable — preview the run, select the matching list row when present, Enter/double-click loads the question into AI Chat (list-row parity).
...
### Changed
- Agent Ops **overview Live**: click a live session opens Sessions, selects the matching live row, and shows preview + Load into AI Chat status (Recent/Schedules overview parity).
...
### Added
- Agent Ops **Agents**: Load into AI Chat puts the open soul/skill/mood file into the composer (Enter / double-click; Loaded flash; Sessions/Knowledge parity).

## [0.1.475] - 2026-08-16

### Added
- Agent Ops **Knowledge**: Load into AI Chat puts the previewed knowledge file into the composer (Enter / double-click; Loaded flash; Sessions/Runs/Schedules parity).
...
### Added
- Agent Ops **Runs**: Load into AI Chat puts the run question into the composer (Enter / double-click; Loaded flash; Sessions parity).

## [0.1.472] - 2026-08-16

### Added
- Agent Ops **Schedules**: click-to-copy schedule id chip under schedule/delivery preview (Copied flash; Sessions/Knowledge parity).
...
**GitHub Release** (first since **v0.1.399**). Ship tag **v0.1.458** includes all product work from **0.1.400–0.1.457**.
Per-commit micro notes: [docs/changelog-archive-micro-0.1.400-0.1.457.md](docs/changelog-archive-micro-0.1.400-0.1.457.md).

### Added
- Top Processes: **GPU%** column on Apple Silicon (AGX); high-GPU processes appear even when CPU is low.
- Monitors: **Delete / Backspace** removes the selected monitor; detail **Remove** with busy-guard.
- Widespread **busy-guards + success flashes** on Save / Copy / Open / Clean / Force Quit / pin / refresh (Agent Ops, Disk Cleanup, Settings, Logs, AI Chat, Perplexity, Discord token, Monitors, Top Processes).
- Keyboard parity: j/k, Esc, PageUp/PageDown, `d` for details across Monitors, Top Processes, Disk Cleanup, Agent Ops.

### Fixed
- Disk Cleanup: no Downloads/Trash TCC prompts on every launch (auto runs only clean `~/.mac-stats`; quarantine soft-delete for auto).
- Disk Cleanup Temp: do not list **root-owned / immutable** files (e.g. stuck Microsoft AutoUpdate `.pkg`) that Clean now cannot remove.
- Top Processes GPU column showing only dashes (ioreg `-l` + empty first-sample cache).
- Process Details: Advanced section stays open across live refresh; Force Quit confirm state preserved.
- Process details refresh no longer rescans **all** processes every tick (selected PID only) — lower CPU with the window open.
- Dark (TUI): Disk Cleanup meta cards equal height; remove `.glass-panel` `height: 100%` so the green border does not cut mid-window.
- CPU window scrollbars nearly invisible (2px, thumb on hover).

### Changed
- Agent Ops: overview Open-tab CTAs, empty-state hints, selection wash, active health/tab highlight, click-to-copy session id and knowledge path, schedule/delivery click-to-preview, Clear filter on filter-miss.
- Monitors: click URL to copy; downtime/meta polish carried from the 0.1.39x line into this ship.
- Disk Cleanup: soft-delete Saved flash; safer soft-delete (skip on EPERM, no permanent fallback).
- CPU window open: slower polling (UI 2s, details 5s, background 2s); less stacked GPU `ioreg`.
- README / Homebrew caveats: maintainer has no Apple Developer account to sign mac-stats — help is welcome ([docs/NOTARIZATION.md](docs/NOTARIZATION.md)).
...
### Added
- Disk Cleanup add-scope form: Enter submits Add (same as the button); focus moves to the new scope row; ⌘/Ctrl+S saves scopes with the Saved flash; hint updated.
...
### Changed
- Second-launch single-instance busy exits: WARN at most once per 5 minutes (stamp beside the lock file); LaunchAgent `KeepAlive` retries stay DEBUG — quieter `debug.log` during install/kickstart races.
...
### Fixed
- Instant overnight / wake-up highlights read morning-surprise **table** rows (`| **v…** | … |`), not only `- **v…**` list bullets — Discord no longer falls back to a generic blurb when tonight’s surprise uses the table format.

### Changed
- Instant lane for product self-changelog asks (“Your changelog?”, “Latest enhancements of Mac-stats?”, “Your latest changes?”) so they skip Brave/LLM.

## [0.1.373] - 2026-08-13

### Changed
- Design review: External / Monitors — summary glass with up/down accents, down/pending row states, clearer URL + latency, history bars, settings focus/press (`feature-monitors`).
- Open Monitors for capture via `MAC_STATS_OPEN_SECTION=monitors` (aliases: `monitor`, `external`, `external-monitors`).
...
### Fixed
- CPU temperature on M4-family Macs uses generation-specific SMC keys (with standard die/proximity tried first).
- SMC health probe requires a real temperature sample (15s budget; prefers fresh cache).

## [0.1.348] - 2026-07-31

### Changed
- Top Processes shows a Process / CPU column header for clearer hierarchy.

## [0.1.347] - 2026-07-31

### Changed
- Top Processes list supports Arrow/Home/End navigation with listbox semantics and focus restore on refresh.
...
### Changed
- Process details modal focus management: Close on open, restore focus to the process row on dismiss.

## [0.1.343] - 2026-07-31

### Changed
- Changelog modal matches Settings dialog a11y: focus Close on open, restore on dismiss, dialog semantics.
...
### Changed
- Logs glass styles shared across themes; Usage metric card and Details/Processes headers get clearer keyboard focus rings.
...
### Changed
- Perplexity results use glass hover cards, weather accent panel, and dashed empty/error states; results region is aria-live.

## [0.1.338] - 2026-07-31

### Changed
- AI Chat (Ollama) section header supports keyboard toggle with aria-expanded; collapse logic shared with the menu action.

## [0.1.337] - 2026-07-31

### Changed
- Perplexity, Logs, and Agent Ops collapsible headers support keyboard toggle with aria-expanded.
...
### Changed
- AI chat shows Intermediate/Final code-exec answers as labeled glass panels instead of `---` text separators.

## [0.1.334] - 2026-07-31

### Changed
- AI chat code-execution cards use glass styles instead of gray inline boxes.
...
### Changed
- Process details dialog semantics on all themes; AI chat response-time label more readable.
...
### Changed
- Agent Ops overview Loading glass placeholders now match across all CPU themes.
...
### Changed
- AI chat: soft message entrance, glass thinking/status copy, send-button press and disabled states.
...
### Changed
- Open-Meteo geocoding uses Spanish locale for clima/klima asks; monitors settings empty state uses dashed glass placeholder.
...
### Changed
- CPU AI chat: style the existing empty-state hint (dashed glass) and highlight the message pane when focused inside.

## [0.1.322] - 2026-07-30

### Changed
- Process list empty state uses the same dashed glass placeholder as Agent Ops; Ollama model `<select>` gets a keyboard focus ring.
...
### Fixed
- Weather: treat “climate” / “clima” (and Spanish `en`) as weather asks; normalize voice STT “L Masnou” → El Masnou for Open-Meteo; prefer Perplexity over Brave when weather cannot be answered instantly.
...
### Changed
- Discord: show typing while `/insights`, `scrub memory`, and `/digest` run; Agent Ops overview cards highlight when a child control is focused.

## [0.1.316] - 2026-07-30

### Changed
- Agent Ops overview: health cards are keyboard-focusable (Enter/Space opens the matching tab).
...
### Changed
- Instant “what can you do / help” reply mentions Discord voice + `/help` operator menu; Ollama connection dot and model label get keyboard focus rings.
...
### Changed
- Monitors chrome: focus rings on ⋯ menu, menu items, add button, and settings close.
...
### Changed
- Discord operator commands: wider NL for `/status` / `/health` / `/digest` (e.g. “system health”, “run digester”, “what version”).
...
### Changed
- Top Processes section: glass card hover matching Details; footer version/GitHub focus rings.

## [0.1.303] - 2026-07-30

### Changed
- History controls: glass-styled time-range dropdown and tooltip (drops the old blue monospace look).
...
### Changed
- CPU Details section: glass card hover, clearer value weight, focusable collapsible header.
...
### Changed
- Pre-route conference/event date reviews (e.g. “Review IBM techxchange dates…”) straight to Brave/Perplexity — skips the planning LLM for that digester Slowest pattern.
...
### Added
- Discord voice notes: download Opus/OGG, convert with ffmpeg to 16 kHz WAV, transcribe via Ollama `/v1/audio/transcriptions` (default model `gemma4:latest`), then run the normal agent path. Override model with `discordVoiceModel` in `config.json` or env `MAC_STATS_DISCORD_VOICE_MODEL` (ffmpeg via `MAC_STATS_FFMPEG` if not on PATH).
...
### Changed
- Agent Ops overview cards: subtle hover lift; “Open” links get a focus ring.
...
### Changed
- Clear flight/airline route asks (“Flights from … to …”) pre-route to Brave/Perplexity (skip planning LLM).

## [0.1.281] - 2026-07-29

### Changed
- Google `/search?q=…` URLs rewrite to Brave/Perplexity instead of FETCH_URL (SERP HTML was a top latency burn).
...
### Changed
- Instant lane: “extract / show what you saved” dumps MEMORY notes verbatim instead of a MEMORY tool loop.

## [0.1.274] - 2026-07-29

### Changed
- Instant lane: “read the exact saved \<slug\> file” returns the MEMORY note verbatim (searches all note scopes; soft-matches typos like tcx26↔txc26) instead of TASK_LIST thrash.
...
### Changed
- Instant lane: “improve each night / what was done” and “how did you solve this task?” skip the model loop and point at Digest / morning surprise.
...
### Changed
- Landing page (`docs/site/index.html`): CPU+SSD / local-first framing aligned with the README vs-competitors pass.
...
### Fixed
- Instant greetings tolerate emoji/punctuation (`Hola 👋`, `hola!!!`) and common Spanish thanks.
...
### Changed
- Process list: clearer empty state, row hover, and smoother CPU bar updates.
...
### Fixed
- Instant lane for “committed / version bumped?” ship-status asks (was ~12s direct).
...
### Fixed
- Instant overnight recap also covers “any improvement lately?” / “improvement loop?” (was ~10–44s lite).

## [0.1.250] - 2026-07-23

### Fixed
- Clippy hygiene: queue cast, host-env contains, scheduler `is_none_or`, tool-name `or`.
...
### Fixed
- Weather place parsing skips “at noon/3pm/…” time-of-day phrases (uses default place instead).
...
### Added
- Perplexity panel shows live Open-Meteo conditions above search results for weather queries.

## [0.1.244] - 2026-07-23

### Fixed
- Default `-v`/`-vv` logs hide Serenity heartbeat/shard-shutdown WARN spam; Discord reconnect lines stay.

## [0.1.243] - 2026-07-23

### Fixed
- Ollama model-list cache no longer WARN-spams on normal stale-while-revalidate (info + shared rate limit).

## [0.1.242] - 2026-07-23

### Changed
- Perplexity result cards render humanized table snippets as a proper bullet list.
...
### Fixed
- Discord insights: infer disconnect count on Ready when heartbeat restarts skip stage updates (no more Ready #N with disconnects=0).

## [0.1.236] - 2026-07-23

### Changed
- Instant “what shipped overnight?” replies include the latest bullets from today's morning surprise file.
...
### Changed
- Downloads-organizer state saves use unique-temp + fsync rename (safer concurrent writes).
- Regression test: GLM 4.7-style newlines between `</arg_key>` and `<arg_value>` still parse.
...
### Changed
- Agent Ops: Space opens the selected row (same as Enter) when not typing in a filter.
...
### Changed
- Agent-run digester: treat short acks / identity affirmations as shipped-instant (stale + drop from Slowest noise).
...
### Changed
- Agent Ops: Home/End jumps list selection to first/last row (with ↑/↓).

## [0.1.218] - 2026-07-22

### Fixed
- Instant lane covers “ok talking on Amvara/Discord?” presence checks (was a ~17s zero-tool direct turn).
...
### Changed
- **Instant lane**: short identity/role affirmations (`You are working for…`, online-on-channels) skip the LLM (digester zero-tool slow turns).
...
### Changed
- **Crash-safe writes**: skill create/edit/defaults and session-memory transcript exports use shared `write_text_atomic`.
...
### Changed
- **Crash-safe writes**: agent files (`agent.json`, skill/soul/mood, prompts), downloads-organizer `config.json` updates, and `credential_accounts.json` use shared `write_text_atomic`.
...
### Changed
- **Agent Ops**: Escape clears the focused list filter (Hermes-style skip/clear).
- **Scheduler**: `schedules.json` writes use crash-safe temp + fsync + rename (`write_text_atomic`).
...
### Added
- **Agent Ops Agents filter**: search agents by name, slug, model, or on/off.
...
### Changed
- Agent Ops toolbar icon uses **warning tint** when Redmine is not configured / degraded (visible without opening the pane).

## [0.1.141] - 2026-07-21

### Changed
- Redmine config read prefers `~/.mac-stats/.config.env` (LaunchAgent-safe) before cwd; Agent Ops Redmine card gets status border colors.
...
### Fixed
- **Redmine under LaunchAgent**: `scripts/sync-home-config-env.sh` merges `REDMINE_*` (and Brave/Perplexity) from `src-tauri/.config.env` into `~/.mac-stats/.config.env`; install runs it so `/Applications` sees the same keys as `cargo run`.
...
### Fixed
- Agent Ops **Load into AI Chat** expands the Ollama section via the same toggle path as the icon (keeps `localStorage` / cpu.js state in sync).
...
### Changed
- **OpenClaw reviewer** — **`Last check`** **`2026-03-31T20:15:00Z`**; digest **`2026-03-30 23:37:21 UTC`**, `DIGEST_SHA256=1a3924c8762aeebb5e016ffc7fbd90b4cef024fa50a629221bd33b0250c1cd70`; range **`2b2edaa01db5..e11b5d584c38`** (**3 commits**); **`origin/main`** **`e11b5d584c`** — **aligned**; local openclaw **`HEAD`** still **mutually non-ancestor**; §7 **`AGENTS.md`** vs **`channel-web.ts`** — **misaligned** on upstream. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`:** **`## Test report`** (**2026-03-30 23:39 UTC**); CDP **`rg`** + **`cargo check`/`cargo test --no-fail-fast`** — **875** pass; outcome **CLOSED-**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`:** **`### 2026-03-31 (local)`** — formal queue restore + **A1** verification — **PASS** (**875**); outcome **CLOSED-**.

## [0.1.83] - 2026-03-31

### Changed
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`:** appended **`## Test report`** (**2026-03-31 UTC**); operator **`UNTESTED-…`** path missing (**`TESTING-…`** at run start); CDP health **`rg`** (**`block_on`** / **`Handle::block_on`**); **`cargo check`** / **`cargo test --no-fail-fast`** — **875** passed; outcome **CLOSED-**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`:** **`### 2026-03-31 (UTC)`** — **`003-tester`/`TESTER.md`** (operator **`UNTESTED-…`** missing; **`CLOSED-`→`TESTING-`** at run start); **A1** **`cargo check`/`test`** + five **`rg`** lines; **875** tests **PASS**; outcome **CLOSED-**.

## [0.1.82] - 2026-03-30

### Changed
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`:** appended **`## Test report`** (2026-03-30; health-check / anti-`block_on` **`rg`**, **`cargo check`**, **`cargo test`** — **875** lib tests passed).
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`:** twelfth-pass operator refresh — queue-prefix rules (**`TESTPLAN-`** vs **`UNTESTED-`**), mac-stats-only scope, tightened acceptance criteria, condensed testing instructions (ultra-short path, cheat sheet, copy-paste **0b** when already at repo root). Removed duplicate **`tasks/UNTESTED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**.
...
### Changed
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T21:50:00Z`**; **independent re-run** **`2026-03-30T21:50:00Z`**: pre-built digest **Generated (UTC)** **`2026-03-30 09:23:14`**, `DIGEST_SHA256=900ebc5d386dec5fcdec3115f534fd5a659c0a043ab4bfd895b50906815582a9`, range **`926693e9933298bd6af74672ea7094bc7d350d4a..43cd29c4afeed642d3c0d80043d2e5a606d0fac4`** (**1 commit**, **10 paths**): **`fix(agents):`** dispose bundled MCP runtime after local runs (#57520) — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**. **`origin/main`** **`43cd29c4af`**; local **`HEAD`** **`de25a3afc7`** still **diverged** at **`0b16443fa4`**. §7 spot checks **Aligned**. **No** new **`FEAT-*`**. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 09:27** UTC, Spanish **`TESTER.md`** flow): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30**, **`003-tester` / `TESTER.md`**, operator **`UNTESTED-…`** only, **Cursor agent**): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** in **`src-tauri/src`** — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line: archivo **`FEAT-…` → `WIP-…` → `UNTESTED-…`**; implementación en **`src-tauri`** (`task/mod.rs`, `task/review.rs`, `commands/context_assembler.rs`, `commands/ollama.rs`); **`cargo check`** / **`cargo test operator_task_pressure`**; **`rg`** opcional incluye **`ollama.rs`**; **§6** lista para el tester.

## [0.1.79] - 2026-03-30

### Changed
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T21:20:00Z`**; **independent re-run** **`2026-03-30T21:20:00Z`**: pre-built digest **Generated (UTC)** **`2026-03-30 08:50:05`**, `DIGEST_SHA256=72f37ea070a8fec57dd2a7191f7bb7571d84b7b97287795feba99528fa8df906`, range **`a804d234cd95..9670bd0823`** (**2 commits**, **2 paths**): **`docs:`** exec approval troubleshooting (`docs/help/troubleshooting.md`); **`fix(test):`** trim session binding registry imports (`src/auto-reply/reply/session.test.ts`) — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**. **`origin/main`** **`9670bd0823`**; local **`HEAD`** **`de25a3afc7`** still **diverged** at **`0b16443fa4`**. §7 spot checks **Aligned**. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: **Test report** consolidated (single **`003-tester`** block); date line generalized (**Cursor** session); **spot-check (criterion 3):** `should_retry_cdp_after_clearing_session` / health-unresponsive retry (`browser_agent/mod.rs` ~5296–5306); removed duplicate trailing test-report sections.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** subsection (**2026-03-30** UTC, **`003-tester` / `TESTER.md`**, operator **`UNTESTED-…`** only): **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** in **`src-tauri/src`** — **pass** → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line clarifies completed **`FEAT → WIP → UNTESTED`** rename chain from pick-up **`UNTESTED-…`**; **`cargo check`** / **`cargo test operator_task_pressure`**; **§6** retained for tester.
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**~20:50** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: re-verify (**2026-03-30** UTC, **`003-tester` / `TESTER.md`**, operator **`UNTESTED-…`** only): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`**; turn-gate **`rg`** in **`src-tauri/src`** — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line documents full **`UNTESTED-` → `FEAT-` → `WIP-` → `UNTESTED-`** rename chain in **`tasks/`**; **`cargo check`** / **`cargo test operator_task_pressure`** green; **§6** for tester; **Next step** names **`UNTESTED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 08:13** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** (incl. `evaluate_one_plus_one_blocking_timeout`, `block_on` prohibition) + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: re-verify (**2026-03-30** UTC, **`003-tester` / `TESTER.md`**, operator **`UNTESTED-…`** only, **agent run**): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`**; turn-gate **`rg`** in **`src-tauri/src`** — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line documents **`FEAT-` → `WIP-` → `UNTESTED-`** on this run and re-verifies **`cargo check`** / **`cargo test operator_task_pressure`** (`operator_task_pressure_summary_empty_dir`); **§6** ready; **Next step** names **`UNTESTED-…`** explicitly.
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 08:05** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: re-verify (**2026-03-30** UTC, **`003-tester` / `TESTER.md`**, Spanish, solo **`UNTESTED-…`**): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** en **`src-tauri/src`** — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line documents completed **`FEAT → WIP → UNTESTED`** workflow; **Next step** names the **`UNTESTED-…`** file explicitly.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T20:00:00Z`** (pre-built digest **Generated (UTC)** **`2026-03-30 07:53:22`**): **`origin/main`** **`ae0e1ecf5c863d94fa201f572b07cb2945012d52`** matches digest **new_sha** (`docs:` tasks cross-refs + `docs/automation/tasks.md` rewrite + `fix(ci)` docs/task-registry guard); range **`8a916652e8b8..ae0e1ecf5c86`**, `DIGEST_SHA256=2c5f79cb6cd692b3da827f8ada6fd542253ca742dab2d26209d72c9b85f43db0`; local **`HEAD`** **`de25a3afc7`** still **diverged** at **`0b16443fa4`** — integrate with **`git pull --rebase origin main`** in `../openclaw` if needed. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test reports (**2026-03-30 07:39** and **07:56** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: re-verify (**2026-03-30** UTC, **`003-tester` / `TESTER.md`**, Spanish + agent runs, solo **`UNTESTED-…`**): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** en **`src-tauri/src`** (coincidencias); **`src/`** raíz sin coincidencias — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line documents **`UNTESTED → FEAT → WIP`** then **`WIP → UNTESTED`**; **`task::tests::operator_task_pressure_summary_empty_dir`** now asserts **`TASK_REVIEW_MAX_OPEN_PER_CYCLE`** and stale-WIP (**`TASK_WIP_STALE_TIMEOUT_SECS`**) wording in the summary; **§6** lista para tester.
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 07:13** UTC, English): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: re-verify (**2026-03-30** UTC, Cursor, Spanish, **`003-tester` / `TESTER.md`**, solo **`UNTESTED-…`**): **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** en **`src-tauri/src`** — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line documents filename workflow **`FEAT-…` → `WIP-…` → `UNTESTED-…`** and **`src-tauri`** vs §2/§4; **§6** ready for tester.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T16:15:00Z`** (pre-built digest **Generated (UTC)** **`2026-03-30 07:01:30`**): **`origin/main`** **`1ad88b58d1`** matches digest **new_sha** (`feat(matrix):` explicit `channels.matrix.proxy`); range **`88716f02de1e..1ad88b58d1dc`**, `DIGEST_SHA256=1249599ef015ca3d64a98c44daf06a4c3c4c59acceec7f3f583b03c810f4c6af`; local **`HEAD`** **`de25a3afc7`** still **diverged** at **`0b16443fa4`** — integrate with **`git pull --rebase origin main`** in `../openclaw` if needed. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 07:04** UTC, Spanish): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30** UTC, English, **`003-tester` / `TESTER.md`**, operator **`UNTESTED-…`** only): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src/`** (none) vs **`src-tauri/src`** (matches) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line: workflow **`FEAT → WIP → UNTESTED`** complete; **`cargo check`** / **`cargo test operator_task_pressure`** pass; **§6** ready; **Next step** — tester **§6** (after **§5**) on **this file**.

## [0.1.78] - 2026-03-30

### Changed
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T05:49:16Z`**; **independent re-run** **`2026-03-30T05:49:16Z`**: digest **Generated (UTC)** **`2026-03-30 05:47:58`**, `DIGEST_SHA256=fd43af93873bb3e12a3d1e6e01413d63d903ba64811bf964b856094f7a3fcfd1`, range **`7304ef663008..833d0e3d6f1f`** (**3 commits**, **5 paths**): **`test:`** Android node capability / location / call log / notification handler coverage (`apps/android/app/src/test/java/ai/openclaw/app/node/*.kt`) — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**. Fetched **`origin/main`** **`05762ed8d7`** (**one** commit past digest tip **`833d0e3d6f`**) vs local **`HEAD`** **`de25a3afc7`** — **diverged** at **`0b16443fa4`**; §7 spot checks **Aligned**. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 05:51** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30 05:52** UTC, **`003-tester` / `TESTER.md`**, operator **`UNTESTED-…`** only): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src/`** (none) vs **`src-tauri/src`** (matches) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line tightens **`FEAT-*`** materialization + **§2** / **Section 6** wording; **Section 6** adds instruction not to strip smoke/checklist when renaming prefixes; **Next step** in Spanish.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T05:39:43Z`**; **independent re-run** **`2026-03-30T05:39:43Z`**: digest **Generated (UTC)** **`2026-03-30 05:38:25`**, `DIGEST_SHA256=75f73b79dc95b2d4837dbaf97a78794985f05be656734b52256427daf1cfdd69`, range **`e5fa976f5c4c..7304ef663008`** (**5 commits**, **6 paths**): **`fix(delivery):`** Matrix **"User not in room"** as permanent delivery error (#57426) in **`PERMANENT_ERROR_PATTERNS`** (`src/infra/outbound/delivery-queue-recovery.ts`) + tests; **`test:`** Android invoke / SMS gating tests; `src/agents/openclaw-tools.camera.test.ts`; **`CHANGELOG.md`** — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**. **`origin/main`** **`7304ef6630`** vs local **`HEAD`** **`de25a3afc7`** — **diverged** (merge-base **`0b16443fa410…`**); §7 spot checks **Aligned** on doc expectations. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 05:41** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30 05:42** UTC, **`003-tester` / `TESTER.md`**, operator **`UNTESTED-…`** only): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src/`** (none) vs **`src-tauri/src`** (matches) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder block **Spanish** alignment + workflow wording; **Section 6** drops redundant **“Run Section 5 first”** lead-in (order covered by checklist above).
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T05:29:08Z`**; **independent re-run** **`2026-03-30T05:29:08Z`**: digest **Generated (UTC)** **`2026-03-30 05:28:15`**, `DIGEST_SHA256=fb51d645b7dcf88ee2ee4d33c44079de10895ba59db72bd27adca8c85aa0fdec`, range **`0b16443fa410..e5fa976f5c4c16909410412a483e0a4f3205c626`** (**1 commit**, **2 paths**): **`test:`** harden Android SMS capability coverage — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**. Local OpenClaw **`HEAD`** **`de25a3afc7`** vs **`origin/main`** **`e5fa976f5c4c`** — **diverged** (shared parent **`0b16443fa4`**); **`git rebase origin/main`** in `../openclaw` to carry the doc commit forward. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 05:31** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30** UTC, Spanish block, **`003-tester` / `TESTER.md`**, único objetivo **`UNTESTED-…`**): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src/`** (none) vs **`src-tauri/src`** (matches) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — **FEATURE-CODER** workflow wording (**`FEAT → WIP → UNTESTED`** rename chain); **§6** adds **minimal smoke** copy-paste (`cargo check`, **`cargo test operator_task_pressure`**) + optional full suite / **`rg`**.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T13:45:00Z`**; **independent re-run** **`2026-03-30T13:45:00Z`**: digest **Generated (UTC)** **`2026-03-30 05:18:25`**, `DIGEST_SHA256=95ddd02d2917d513b345e0d6658f42d6e645d65c7f87fbb5bc82cad9c24ba47e`, range **`126f77315f0b..0b16443fa4104d0d21444ddc7ee448ad9ed2b3d6`** (**14 commits**, **39 paths**): Android SMS search finalize (#50146) + large `apps/android/**`; **`refactor(cron):`** split main vs detached dispatch (#57482); **`refactor(tasks):`** route ACP/subagents through executor + guard executor-only writes + detached surfaces (#57478–#57486); **`fix(tasks):`** restore user-facing task wording; test/registry cleanups — **no** root **`AGENTS.md`** in digest paths, but **`git show origin/main:AGENTS.md`** at tip still cited **`src/provider-web.ts`** (**misaligned** vs **`src/channel-web.ts`** on disk). Local OpenClaw **`HEAD`** **`de25a3afc7`** — doc-align replayed on **`origin/main`** **`0b16443fa4`** (**ahead 1** until push/PR). Spot checks: **`pnpm check`** does not chain **`pnpm format:check`**; **`vitest.config.ts`** **70/70/55/70** — **Aligned** on **`de25a3afc7`**. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 05:21** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`** stand-in; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30 05:22** UTC, **`003-tester` / `TESTER.md`**, operator **`UNTESTED-…`** only): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src/`** (none) vs **`src-tauri/src`** (matches) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line documents **canonical** **`UNTESTED-…`** file (no in-tree **`FEAT-…`**); **Next step** — tester **Section 6** after **Section 5**.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T04:45:00Z`**; **independent re-run** **`2026-03-30T04:45:00Z`**: digest **Generated (UTC)** **`2026-03-30 04:38:29`**, `DIGEST_SHA256=2eb081feab0e958eab9e7a11c9919619cb7b73a3c4731aed50d6eb8b6130e695`, range **`6af52b4ce385..b26092cf0108de18442e93a7b30b1836a4b75694`** (**6 commits**, **22 paths**): **`fix(test):`** close task registry sqlite after reset; **`Tests:`** force-reset session cleanup between runs; **`fix(test):`** trim onboarding post-write registry imports; **`refactor(tasks):`** add executor facade (#57474); **`fix(agents):`** prevent unhandled rejection when compaction retry times out (#57451); **`fix:`** finalize Android notification forwarding controls (#40175) — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**; **Aligned**; local **`HEAD`** **`c36fc1bdcc`** vs **`origin/main`** **`b26092cf0108`** — **diverged** (common ancestor **`f380305ee4`**) — merge/rebase upstream in openclaw; §7 table line refs **Vitest** (**`L177`**) and **`pnpm tsgo`** (**`L113`**). (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 04:41** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
...
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line documents **`UNTESTED → FEAT → WIP → UNTESTED`** cycle and **`commands/ollama.rs`** wiring wording (**`←`**); **Next step** — tester **Section 6** after **Section 5**.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T04:12:26Z`**; **independent re-run** **`2026-03-30T04:12:26Z`**: digest **Generated (UTC)** **`2026-03-30 04:11:38`**, `DIGEST_SHA256=c993f33cc913bef2e831f8a6bd60b8598916eed142b53c3bb4934e7aec932927`, range **`ca2a67e07ee08bf5ed207fc98a5de794d7ee3a2a..ab43bbd62bbf04d7f35baac2350b6de189ea6a60`** (**2 commits**, **13 paths**): **`refactor(tasks):`** split delivery state from task runs; **`fix(test):`** minimal outbound binding registries — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**; **Aligned**; local **`HEAD`** **`c36fc1bdcc`** vs **`origin/main`** **`ab43bbd62bbf`** — **diverged** (common ancestor **`f380305ee4`**) — merge/rebase upstream in openclaw. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 04:14** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30** UTC, Spanish block, **`003-tester` / `TESTER.md`**, único objetivo lógico **`UNTESTED-…`**): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src/`** (none) vs **`src-tauri/src`** (matches) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line cites **`commands/ollama.rs`** wiring and test name; **Section 6** adds required order, quick checklist, **Section 5** first.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T04:02:42Z`**; **independent re-run** **`2026-03-30T04:02:42Z`**: digest **Generated (UTC)** **`2026-03-30 04:01:28`**, `DIGEST_SHA256=639a1576d86c46cc3e85e3102820143469673eee289af587ce1899c8f9fbddbe`, range **`b7d59f7831521d41e385953035090e5a5be65b9e..ca2a67e07ee08bf5ed207fc98a5de794d7ee3a2a`** (**4 commits**, **5 paths**): **`Slack:`** action-threading tests consolidated in extension; **`fix(agents):`** classify Anthropic `"unexpected error"` / `api_error` as transient (#57441); **`fix(test):`** bypass Slack facade in message-action-params test; **`CHANGELOG.md`** + billing-error unit test — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**; **Aligned**; local **`HEAD`** **`c36fc1bdcc`** vs fetched **`origin/main`** **`ca2a67e07ee0`** — **diverged** — merge/rebase upstream in openclaw. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 04:04** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30** UTC, **`003-tester` / `TESTER.md`**, operator **`UNTESTED-…`** only): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src-tauri/src`** vs top-level **`src/`** — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line tightens **UNTESTED↔WIP** cycle wording and verified paths; **Next step** — tester **Section 6** after **Section 5**.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T03:52:25Z`**; **independent re-run** **`2026-03-30T03:52:25Z`**: digest **Generated (UTC)** **`2026-03-30 03:50:59`**, `DIGEST_SHA256=5922567cd32ae59cd0faf303c91ab3c540f9676e1a6ea533fcd6d483a7616ad2`, range **`8c163c14bcd223da3a450230a95274af9aa322b2..b7d59f7831521d41e385953035090e5a5be65b9e`** (**6 commits**, **20 paths**): memory QMD + task-registry refactor + config/cron/matrix test churn — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**; **Aligned**; local **`HEAD`** **`c36fc1bdcc`** vs fetched **`origin/main`** **`dd23e744f4`** — **diverged** — merge/rebase upstream in openclaw. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30** UTC, English **`TESTER.md`** block): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30** UTC, Spanish **`003-tester`** subsection): **`UNTESTED-…`** absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src-tauri/src`** (matches) vs **`src/`** (none) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line clarifies **`FEAT-…`** file **not present**; **UNTESTED↔WIP** renames as **FEAT→WIP→UNTESTED** equivalent; **no code changes**; **`cargo check`** / **`cargo test operator_task_pressure`** — pass; **Next step** — tester **Section 6** after **Section 5**.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T04:00:00Z`**; **independent re-run** **`2026-03-30T04:00:00Z`**: digest **Generated (UTC)** **`2026-03-30 03:40:39`**, `DIGEST_SHA256=462355167cd966d132760b5b016341ef17ada7669e44a880418c860540598bea`, range **`0fe193db6ab17cc4be578a90d35eb8c179b87364..8c163c14bcd223da3a450230a95274af9aa322b2`** (**3 commits**, **6 paths**): **`feat(tasks):`** maintenance repair hardening (#57439); **`WhatsApp:`** deliver-reply test mocks; **`Telegram:`** channel test runtime probe — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**; **Aligned**; local **`HEAD`** **`c36fc1bdcc`** vs **`origin/main`** **`8c163c14bc`** — **diverged** — merge/rebase upstream in openclaw. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 03:44** UTC, Spanish **`TESTER.md`** flow): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30** UTC, Spanish block, **`003-tester` / `TESTER.md`**, only **`UNTESTED-…`** target): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src-tauri/src`** — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30T03:34:16Z** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`** stand-in; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30T03:34:54Z** UTC, **`003-tester` / `TESTER.md`**, only **`UNTESTED-…`** target): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src/`** vs **`src-tauri/src`** — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — coder line documents **FEAT → WIP → UNTESTED** cycle and explicit **`UNTESTED-…`** artifact; **Next step** — tester **Section 6** after **Section 5**.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T03:35:00Z`**; **independent re-run** **`2026-03-30T03:35:00Z`**: digest **Generated (UTC)** **`2026-03-30 03:22:17`**, `DIGEST_SHA256=76b75ac7c37fc9362885b9a12d319d8fea3f41dd65145a90167fb196026048ed`, range **`e86a2183dfc1715325545f57f3ea3e01fd1881a8..0fe193db6ab17cc4be578a90d35eb8c179b87364`** (**3 commits**, **6 paths**): **`Discord:`** restore message utils media-runtime mocks; **`Tests:`** read packed manifest without shell tar; **`Status:`** keep fast JSON off task audit runtime — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**; **Aligned**; local **`HEAD`** **`c36fc1bdcc`** vs **`origin/main`** **`0fe193db6ab1`** — **diverged** — merge/rebase upstream in openclaw. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 03:25** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30** UTC, **`003-tester` / `TESTER.md`**, only **`UNTESTED-…`** target): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** in **`src-tauri/src`** — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — **FEATURE-CODER** documents picked **`FEAT-…`** path and cycle; **Next step** — tester **Section 6** (after **Section 5**) on this **`UNTESTED-…`** file.
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30** UTC, sesión posterior a **02:55** UTC): operador **`UNTESTED-…`** ausente; equivalencia **`CLOSED-` → `TESTING-`**; **`rg`** health-check / anti-`block_on` + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30** UTC, **`003-tester` / `TESTER.md`**, solo objetivo **`UNTESTED-…`**): fichero ausente; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** en **`src-tauri/src`** — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — referencia explícita a **`006-feature-coder/FEATURE-CODER.md`** y ciclo de nombres; verificación **pass on this run**; **Next step** — tester **Section 6** tras **Section 5**.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T03:03:36Z`**; **independent re-run** **`2026-03-30T03:03:36Z`**: digest **Generated (UTC)** **`2026-03-30 03:02:31`**, `DIGEST_SHA256=9b269f3b96e6d5f949cdc031c1ea5d79cf10f8649f3cf09f07ecc841fbabd9d3`, range **`03a03c2dc47c0f55ef6cd6ba5dc7afffd9d4b853..51e053d0e82fc18afe83b8f8462f1659a967a21a`** (**1 commit**, **1 path**): **`OpenAI:`** preserve oauth exports in index tests — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**; **Aligned**; local **`HEAD`** vs digest tip **diverged** — **`git fetch`** + merge/rebase to **`51e053d0e82f`**. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 03:05** UTC): operator **`UNTESTED-…`** path missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30T12:00:00Z** UTC, **`003-tester` / `TESTER.md`**, only **`UNTESTED-…`** target): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src-tauri/src`** vs **`src/`** — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — **FEATURE-CODER** cycle wording; **Next step** — tester runs **Section 6** after **Section 5**.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T10:15:00Z`**; **independent re-run** **`2026-03-30T10:15:00Z`**: digest **Generated (UTC)** **`2026-03-30 02:50:32`**, `DIGEST_SHA256=2fd24b929a187bdc4c6e4b140793af38ea05fef72d2f21fc91ee03b177950ae8`, range **`e57b3618fc8d7b60392b3e506fb32320a998c638..03a03c2dc47c0f55ef6cd6ba5dc7afffd9d4b853`** (**3 commits**, **6 paths**): **`fix(ci):`** skill fixtures + security doc anchors; **`Tests:`** extension plugin test seams; **`Matrix:`** runtime wrapper off monolithic sdk root — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**; **Aligned**; local **`HEAD`** and digest tip **sibling commits** — **`git fetch`** + merge/rebase to **`03a03c2dc47c`**. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`**: append **`003-tester`** test report (**2026-03-30 02:55** UTC): operator **`UNTESTED-…`** missing; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**: **Re-verify** (**2026-03-30** UTC, **`003-tester` / `TESTER.md`**, only **`UNTESTED-…`** target): path absent; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src-tauri/src`** vs **`src/`** — pass → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: triage (**TOP**) — **FEATURE-CODER** cycle documents **`UNTESTED` → `FEAT` → `WIP`** rename path; **Next step** still **Section 6** (start with **Section 5**).
- **Build** — **`src-tauri/Cargo.lock`**: sync **`mac_stats`** package stanza version to **`0.1.78`** (matches **`Cargo.toml`**).
...
### Added
- **Ollama / agent router** — **`task::format_operator_task_pressure_summary`**: execution system prompt (via **`context_assembler::fragments::live_metrics_execution_system_section`**) now includes a **Task backlog (operator)** block with task counts and review-loop limits (**`task/review.rs`** exposes **`TASK_REVIEW_INTERVAL_SECS`**, **`TASK_REVIEW_MAX_OPEN_PER_CYCLE`**, **`TASK_WIP_STALE_TIMEOUT_SECS`** for a single source of truth). Unit test **`operator_task_pressure_summary_empty_dir`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`**: OpenClaw parity handoff — acceptance criteria and testing instructions for the execution-time backlog block.

### Changed
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T02:05:00Z`**; **independent re-run** **`2026-03-30T02:05:00Z`**: digest **Generated (UTC)** **`2026-03-30 01:58:25`**, `DIGEST_SHA256=d7f4358176654c4924d38b8486995f903be1638951e8f457dc0b8a06001d3df4`, range **`f44174cf61b5e3b2c75277abc8051e01a5a02999..acea28a9bb1651ebfe67bd6e48d272b45cc8c00e`** (**2 commits**, **21 paths**): **`fix(exec):`** async exec-approval followup when the turn has no deliverable external target (`resolveExternalBestEffortDeliveryTarget`, **`src/infra/outbound/best-effort-delivery.ts`**, gateway wiring) + Telegram extension-fast test seams — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**; **Aligned**; **`git pull`** to **`acea28a9bb16`**. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`** — **Test report** (**2026-03-30** UTC): Spanish labels for tester flow / commands; **`rg block_on`** line documents **`check_browser_alive`** comments and `evaluate_one_plus_one_blocking_timeout` docs (**still pass**).
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`** — **`003-tester`** **Re-verify** (**2026-03-30** UTC, Spanish block): operator **`UNTESTED-…`** missing; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src-tauri/src`** vs **`src/`** — **pass** → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`** — triage (**TOP**): FEATURE-CODER filename-prefix cycle wording; explicit in-tree paths; re-verify **`cargo check`** / **`cargo test operator_task_pressure`**.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T23:50:00Z`**; **independent re-run** **`2026-03-30T23:50:00Z`**: digest **Generated (UTC)** **`2026-03-30 01:22:37`**, `DIGEST_SHA256=3740ecea3e2a6df4afae732dc6a4055387af5bcfefc6e899bb0ee043df0370c9`, range **`b952e404fa253d1ea3ea86252d1951a068c158d5..66f8fb9e9bc2b1b2eb07cf9a9ca129f0ca789298`** (**10 commits**, **7 paths**): **docs-only** — hooks, Discord, CLI index, gateway configuration-reference + security, FAQ, plugins architecture — **no** root **`AGENTS.md`**, root **`package.json`**, or **`vitest.config.ts`**; **Aligned**; local openclaw **`HEAD`** behind digest tip — **`git pull`** to **`66f8fb9e9bc2`**. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`** — append **`003-tester`** **Test report** (**2026-03-30T01:25:18Z** UTC): operator **`UNTESTED-…`** path **absent**; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — **pass** → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`** — **`003-tester`** **Re-verify** (**2026-03-30** UTC): same operator flow; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** in **`src-tauri/src`** vs **`src/`** — **pass** → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`** — triage summary (**TOP**): coder line clarifies **mac-stats implementation validated** (wording only).
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T22:30:00Z`**; **independent re-run** **`2026-03-30T22:30:00Z`**: digest **Generated (UTC)** **`2026-03-30 00:55:38`**, `DIGEST_SHA256=cf8636b7b76ef6db677574a841a395b0f57fabb75f70af72fc556d8d467f8555`, range **`9b33380fb6817c40d5d06467d28693e45afac8af..b952e404fa253d1ea3ea86252d1951a068c158d5`** (**11 commits**, **10 paths**): Control UI gateway connect-timeout cleanup (#57338) plus doc-only churn — touches **`ui/src/ui/gateway.ts`** (+ test), **`docs/*`**, **`CHANGELOG.md`** — **no** root **`AGENTS.md`**, root **`package.json`** scripts, or **`vitest.config.ts`**; **Aligned**; local openclaw **`HEAD`** still behind digest tip — **`git pull`** to **`b952e404fa25`**. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`** — append **`003-tester`** **Test report** (**2026-03-30T00:59:11Z** UTC): operator **`UNTESTED-…`** path **not present**; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — **pass** → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`** — **`003-tester`** **Re-verify** (**2026-03-30** UTC, operator **`UNTESTED-…`** only): **`UNTESTED-…`** **not present**; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** in **`src-tauri/src`** — **pass** → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`** — triage header notes **§6** automated-first; **§6** adds a lead-in to run **§5** before manual checks.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T21:45:00Z`**; **independent re-run** **`2026-03-30T21:45:00Z`**: digest **Generated (UTC)** **`2026-03-30 00:37:47`**, `DIGEST_SHA256=2b61cb7853ca8fb5996e0d43d1c522c31877bfdfdf24e17d54f298a520542bae`, range **`f3bf7fe53a36fbb2c85243efa889abae1a5b99d3..9b33380fb6817c40d5d06467d28693e45afac8af`** (**8 commits**, **53 paths**): QMD / `/v1/responses` flat schema, Telegram + CLI status hardening, extension test-support renames, xAI auth trace removal, memory qmd glob flags, etc. — **no** root **`AGENTS.md`**, **`package.json`**, or **`vitest.config.ts`**; **Aligned** on spot checks; local openclaw **`HEAD`** still behind digest tip — **`git pull`** to **`9b33380fb681`**. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`** — append **`003-tester`** **Test report** (**2026-03-30T00:40:38Z** UTC): operator **`UNTESTED-…`** **not present**; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — **pass** → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`** — **`003-tester`** **Test report** (**2026-03-30** UTC): same operator flow; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** **`src/`** vs **`src-tauri/src`** — **pass** → **`CLOSED-…`**.
- **Tasks** — **`tasks/UNTESTED-20260330-2030-openclaw-operator-task-pressure-summary.md`** — **Coder verify** (`cargo check`, **`cargo test operator_task_pressure`**) plus **How to test** clarifies the **`operator_task_pressure`** filter, static order after **`live_metrics_for_prompt`**, optional error-path review, and runtime log/debugger steps.
- **OpenClaw reviewer** — **`Last check`** **`2026-03-30T00:30:00Z`**; **independent re-run** **`2026-03-30T00:30:00Z`**: digest **Generated (UTC)** **`2026-03-30 00:28:49`**, `DIGEST_SHA256=3f05a2fc1dfec8644ba50804c459b4ba750512b9bb62e3af3cc6f68979195b6d`, range **`9857d40923adb99043b25649d3498c48eb409895..f3bf7fe53a36fbb2c85243efa889abae1a5b99d3`** (**2 commits**): release **2026.3.30** + memory QMD sync parity hooks — **Aligned**; **`git pull`** tip **`f3bf7fe53a36fbb2c85243efa889abae1a5b99d3`**; **Upstream status** notes digest touches root **`package.json`** (re-verify **`check`** chain after pull). (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`** — append **`003-tester`** **Test report** (**2026-03-30T00:31:20Z** UTC): operator **`UNTESTED-…`** **not present**; **`CLOSED-` → `TESTING-`**; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**875** lib tests) — **pass** → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`** — **`003-tester`** **Re-verify** (**2026-03-30** UTC, operator path only): **`UNTESTED-…`** **not present**; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests); turn-gate **`rg`** in **`src/`** (no matches) vs **`src-tauri/src`** (matches) — **pass** → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`** / **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`** — additional **`003-tester`** pass (**2026-03-30 ~00:22Z** UTC): operator **`UNTESTED-…`** slugs **not present**; **`CLOSED-` → `TESTING-`**; **`cargo check`** / **`cargo test`** (**875** lib tests) + **`rg`** as in task bodies — **pass** → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`** — append **`003-tester`** **Test report** (**2026-03-30T00:11:47Z** UTC): operator **`UNTESTED-…`** **not present**; **`CLOSED-` → `TESTING-`** stand-in; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**874** lib tests); **pass** → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`** — **`003-tester`** **Re-verify** (**2026-03-30T00:12:21Z** UTC, **`TESTER.md`**): operator **`UNTESTED-…`** **not present**; **`CLOSED-` → `TESTING-`** cycle; **`cargo check`** / **`cargo test`** (**874** lib tests); turn-gate **`rg`** in **`src-tauri/src`** — **pass** → **`CLOSED-…`**.
- **OpenClaw reviewer** — Independent re-run **`2026-03-30T20:30:00Z`**; pre-built digest **Generated (UTC)** **`2026-03-29 22:59:31`**, `DIGEST_SHA256=8c4cfdd81953909d1a03932d2b1e3603c60dce97b347552ce9d86cc822847406`, range **`1efef8205cf1..924c264a7434`** (**2 commits**): root-help plugin descriptors non-activating + plugin loader / `captured-registration` / Matrix + anthropic OAuth `service_tier` — **no** root **`AGENTS.md`**, **`package.json`**, or **`vitest.config.ts`**; **Aligned** — **`git pull`** in openclaw to **`924c264a7434ef94a2527b6636629683f98eb81a`**. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks** — **`tasks/CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`** — append **`003-tester`** **Test report** (**2026-03-29T23:01:39Z** UTC): operator **`UNTESTED-…`** **not present**; **`CLOSED-` → `TESTING-`** cycle; health-check / anti-`block_on` **`rg`** + **`cargo check`** / **`cargo test --no-fail-fast`** (**874** lib tests); **pass** → **`CLOSED-…`**.
- **Tasks** — **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`** — **append** **`003-tester`** **Re-verify** (**2026-03-30** UTC, **`TESTER.md`**): operator **`UNTESTED-…`** **not present**; **`CLOSED-` → `TESTING-`** cycle; **`cargo check`** / **`cargo test`** (**874** lib tests); **`rg`** in **`src/`** (no matches) vs **`src-tauri/src`** (matches) — **pass** → **`CLOSED-…`**.
...
### Changed
- **Tasks / docs** — Ollama startup-gate **`tasks/CLOSED-20260322-1920-openclaw-ollama-warmup-before-channels.md`** — closing reviewer **verify #71**; **`docs/022_feature_review_plan.md`** — checklist **verify #70–#71** (**2026-03-29T09:27:42Z** UTC).
- **Tasks / docs** — Ollama startup-gate **`tasks/CLOSED-20260322-1920-openclaw-ollama-warmup-before-channels.md`** — closing reviewer **verify #70**; **`docs/022_feature_review_plan.md`** — checklist **verify #69–#70** (**2026-03-29T09:13:19Z** UTC).
...
- **Tasks** — **CLOSED** browser / OpenClaw / Discord tracks — **`003-tester`** **test report** rows (**verify #70** snapshot across **eight** **`tasks/CLOSED-*.md`**): same tracks as verify #69 (`cargo check`, **clippy** `-D warnings`, **872** lib tests + **1** ignored doc-test, **`cargo build --release`** **v0.1.73**, **`rg`** where noted).
- **Tasks** — **`tasks/UNTESTED-20260329-0847-openclaw-silent-expected-turns.md`** — **How to test** adds **`rg`** steps for skip log lines (`Schedule ack — not delivering` / `schedule heartbeat ack — not delivering`) in **`~/.mac-stats/debug.log`**.
...
### Fixed
- **Ollama model list cache (`/api/tags`)** — Centralized merge rules so an **empty** successful response or a **fetch error** does **not** replace a **prior non-empty** cached list (stale list returned when available). Unit tests cover merge edge cases. (`ollama/model_list_cache.rs`.)
- **Browser shutdown vs busy session mutex** — `close_browser_session` uses **`try_lock`** so signal-driven shutdown does not block indefinitely when another thread holds the CDP session; **poisoned** mutex recovery still drops the session; **`WouldBlock`** path logs and runs the **orphan headless-Chrome sweep** plus log flush. Always runs the **pgrep**-style orphan sweep after a normal close as a safety net. (`browser_agent/mod.rs`, `lib.rs`.)
- **CDP navigate URL normalization** — `about:blank` / `about:srcdoc` (including trivial `?` / `#` suffixes) and the same **`chrome://new-tab-page`** / **`chrome://newtab`** surfaces as elsewhere in the browser agent are passed through to **`Page.navigate`** without prepending **`https://`**, avoiding invalid URLs such as **`https://about:blank`**. (`commands/browser.rs`, unit tests.)
- **Startup CDP log noise** — Removed the delayed **`browser/doctor`** INFO line that implied operators must start Chromium when nothing listened on the CDP port; with browser tools enabled, mac-stats typically launches Chromium **lazily** on the first **`BROWSER_*`** tool call. Use **`mac_stats --browser-doctor`** for manual diagnostics. (`lib.rs`, `browser_doctor.rs`.)
...
### Added
- **Tests** — **`model_list_cache::merge_tests`** for **`/api/tags`** stale-merge rules; **`new_focus_index_after_close`** cases for managed-tab-cap focus after tab closes. (`ollama/model_list_cache.rs`, `browser_agent/mod.rs`.)

### Changed
- **Tasks / OpenClaw reviewer** — Additive **CLOSED** task notes; new **`tasks/CLOSED-20260321-2000-openclaw-hung-turn-timeout-event-gate.md`**; **`tasks/TESTED-20260322-1920-openclaw-ollama-warmup-before-channels.md`**; several **`tasks/UNTESTED-*.md`** tracks (Ollama request queue, inbound debounce, draft stream throttle, CDP crash recovery, managed-tab cap, browser action timeout diagnostics, scheduler main-session awareness); **Discord** reply-to-bot **CLOSED** file trimmed; scheduler main-session **CLOSED** filename rotated to **UNTESTED**. Independent reviewer re-run **`2026-03-28T15:23:58Z`**; **OpenClaw** **`HEAD`** unchanged **`55dc6a8bb28d`** (**Aligned**). (`tasks/`, `005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Agent router wall-clock timeout** — **`mac_stats_warn!`** when the output gate closes after a turn timeout; user-facing copy uses **“Turn timed out”** (still distinguishes **`agentRouterTurnTimeoutSecs*`** vs **`ollamaChatTimeoutSecs`**). (`commands/ollama.rs`, `commands/turn_lifecycle.rs`.)
- **CPU window / dashboard chat** — Injects the **markdown memory** block **before** Ori lifecycle sections on initial chat and on **continue** (code ping-pong), matching **`docs/ori-lifecycle.md`**. (`commands/ollama_frontend_chat.rs`, `docs/ori-lifecycle.md`.)
- **Browser tool logging** — **`BROWSER_CLICK`**: **info** when falling back to **`click_http`** after CDP failure and when that fallback succeeds. (`commands/browser_tool_dispatch.rs`.)
- **Shutdown observability** — **INFO** `mac_stats::browser_shutdown` line on **SIGINT/SIGTERM/SIGHUP** before closing the browser session; **`RunEvent::Exit`** path upgraded to **INFO**; **`sync_debug_log_best_effort`** around **`close_browser_session`** so traces hit **`~/.mac-stats/debug.log`** under default **`-vv`**. (`lib.rs`.)
- **Config** — Shared **`clamp_ollama_global_concurrency_n`** (**1..=16**) for env + JSON; unit test for clamp behaviour. (`config/mod.rs`.)
- **Discord** — Comment pointing debounce bypass rules to **`message_debounce::discord_message_bypasses_debounce`**. (`discord/mod.rs`.)
- **Docs** — Router/agents, feature review plan, browser automation touch-ups. (`docs/021_router_and_agents.md`, `docs/022_feature_review_plan.md`, `docs/029_browser_automation.md`.)
- **Heartbeat fast path** — Skips the completion-verification LLM call at end of router turns when the heartbeat preamble applies, and skips **Redmine create-context** fetches in that mode (heartbeat checklist wording could false-trigger the create/update heuristic). (`commands/ollama.rs`, `commands/agent_descriptions.rs`.)
- **Browser interactables / AX merge** — **DOMSnapshot** paint filtering records **`backendNodeId`** on each row so the AX merge can reuse it and skip a redundant **`DOM.describeNode`** on dense pages (**debug** may log how many rows reused). (`browser_agent/dom_snapshot.rs`, `browser_agent/mod.rs`.)
- **Ollama HTTP queue** — **Info** log under **`ollama/queue`** when the global semaphore permit is acquired (key + remaining permits). (`ollama_queue.rs`.)
- **Feature health (browser)** — Degraded CDP message clarifies the port is idle until the first **`BROWSER_*`** tool use (on-demand launch). (`feature_health.rs`.)
- **Tasks / OpenClaw reviewer** — Further additive **CLOSED** task notes; **session-timeout alignment** tracking lives under **`tasks/TESTING-20260322-1805-openclaw-agent-session-timeout-alignment.md`** (prior **CLOSED** filename removed). Independent reviewer re-run **`2026-03-28T12:11:39Z`**; **OpenClaw** **`HEAD`** unchanged **`55dc6a8bb28d`** (**Aligned**). (`tasks/`, `005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Docs** — Heartbeat verification / Redmine context, CDP internal URL normalization, DOMSnapshot AX reuse, and **`ollama/queue`** subsystem. (`docs/009_scheduler_agent.md`, `docs/029_browser_automation.md`, `docs/039_mac_stats_log_subsystems.md`.)
- **Tasks / OpenClaw reviewer** — Further additive **CLOSED** task notes under **`tasks/`** (~**+437** lines, **27** files: test reports, preflight, `cargo check` / targeted `cargo test`, `rg` wire checks, operator guidance). Independent reviewer re-run **`2026-03-28T11:49:56Z`**; **OpenClaw** **`HEAD`** unchanged **`55dc6a8bb28d`** (**Aligned**). (`tasks/`, `005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks / OpenClaw reviewer** — Further additive **CLOSED** task notes under **`tasks/`** (~**+438** lines, **27** files: test reports, preflight, `cargo check` / targeted `cargo test`, `rg` wire checks, operator guidance). Independent reviewer re-run **`2026-03-28T11:25:41Z`**; **OpenClaw** **`HEAD`** unchanged **`55dc6a8bb28d`** (**Aligned**). (`tasks/`, `005-openclaw-reviewer/005-openclaw-reviewer.md`.)
...
### Changed
- **Tasks / OpenClaw reviewer** — Additive edits on **CLOSED** task notes under **`tasks/`** (~**+392** net lines: workflow, verification, failure modes, operator guidance across the same CLOSED browser/OpenClaw tasks; one file trimmed while others grew). Independent reviewer re-run **`2026-03-28T09:27:33Z`**; **OpenClaw** **`HEAD`** unchanged **`55dc6a8bb28d`** (**Aligned**). (`tasks/`, `005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks / OpenClaw reviewer** — Additive edits on **CLOSED** task notes under **`tasks/`** (~**+440** lines: workflow, verification, failure modes, operator guidance across heartbeat, LLM screenshot coords, CDP health, SPA dwell, graceful shutdown, click fallbacks, in-page search, partial progress, poisoned cache, form routing, Ollama queue, abort/cutoff, inbound debounce, draft stream throttle, keyed async queue, CDP downloads, Ori Mnemos, target-crashed recovery, focused-tab screenshot, session timeout, managed-tab cap, action timeout / console error diagnostics, browser history forward/reload, scheduler main-session awareness, Discord reply-to-bot mention). Independent reviewer re-run **`2026-03-28T09:05:26Z`**; **OpenClaw** **`HEAD`** unchanged **`55dc6a8bb28d`** (**Aligned**). (`tasks/`, `005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks / OpenClaw reviewer** — Additive edits on **CLOSED** task notes under **`tasks/`**; **browser history forward/reload** notes moved from **`WIP-20260323-0130-…`** to **`CLOSED-20260323-0130-browser-history-forward-reload-tools.md`**. Independent reviewer re-run **`2026-03-28T08:43:38Z`**; **OpenClaw** **`HEAD`** unchanged **`55dc6a8bb28d`** (**Aligned**). (`tasks/`, `005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks / OpenClaw reviewer** — Additive edits on **CLOSED** / **WIP** task notes under **`tasks/`** (~**+454** lines: workflow, verification, failure modes, operator guidance). Independent reviewer re-run **`2026-03-28T08:23:26Z`**; **OpenClaw** **`HEAD`** unchanged **`55dc6a8bb28d`** (**Aligned**). (`tasks/`, `005-openclaw-reviewer/005-openclaw-reviewer.md`.)
...
- **Tasks / OpenClaw reviewer** — Further additive edits on the same **CLOSED** / **WIP** task files under **`tasks/`** (~**+432** lines: workflow, verification, failure modes, operator guidance). Independent reviewer re-run **`2026-03-28T06:39:31Z`**; **`HEAD`** unchanged **`55dc6a8bb28d`** (**Aligned**). (`tasks/`, `005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks / OpenClaw reviewer** — Further additive edits on the same **CLOSED** / **WIP** task files under **`tasks/`** (~**+432** lines: workflow, verification, failure modes, operator guidance). Independent reviewer re-run **`2026-03-28T06:18:48Z`**; **`HEAD`** unchanged **`55dc6a8bb28d`** (**Aligned**). (`tasks/`, `005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks / OpenClaw reviewer** — Further additive edits on the same **CLOSED** / **WIP** task files under **`tasks/`** (~**+436** lines: workflow, verification, failure modes, operator guidance). Independent reviewer re-run **`2026-03-28T05:58:43Z`**; **`HEAD`** unchanged **`55dc6a8bb28d`** (**Aligned**). (`tasks/`, `005-openclaw-reviewer/005-openclaw-reviewer.md`.)
- **Tasks / docs** — Continued expanding **CLOSED** / **WIP** task notes under **`tasks/`** (OpenClaw heartbeat periodic check, LLM screenshot resize/coords, CDP health ping, SPA dwell, graceful shutdown, click fallbacks, in-page search, partial progress, poisoned cache, form routing, Ollama queue, abort/cutoff, inbound debounce, draft stream throttle, keyed async queue, CDP downloads, Ori Mnemos, target-crashed recovery, focused-tab screenshot, session timeout, managed-tab cap, action timeout / console error diagnostics, scheduler main-session awareness, Discord reply-to-bot mention; **WIP** browser history forward/reload) with iterative workflow, verification, implementation, failure-mode, and operator detail (another additive pass on the same files). **CDP health ping** recorded as **`CLOSED-20260321-1345-browser-use-cdp-health-check-ping.md`** (test report / acceptance); interim **`TESTING-20260321-1345-…`** filename removed. Follow-up passes add more checkpoints, regression notes, and operator guidance in the same task files (this pass ~**+437** lines; prior committed pass ~**+399**; earlier ~**+430**).
- **OpenClaw reviewer** — Independent re-runs latest **`2026-03-28T07:00:06Z`**; prior **`2026-03-28T06:39:31Z`** / **`2026-03-28T06:18:48Z`** / **`2026-03-28T05:58:43Z`** / **`2026-03-28T05:36:46Z`** / **`2026-03-28T05:14:08Z`** / **`2026-03-28T04:52:19Z`** / **`2026-03-28T04:29:46Z`** / **`2026-03-28T04:07:57Z`** / **`2026-03-28T03:33:32Z`** / **`2026-03-28T03:02:27Z`** / **`2026-03-28T02:40:31Z`** / **`2026-03-28T02:19:17Z`** / **`2026-03-28T01:58:14Z`** / **`2026-03-28T01:08:14Z`** / **`2026-03-28T00:23:15Z`** / **`2026-03-27T23:40:20Z`** / **`2026-03-27T23:10:18Z`** / **`2026-03-27T22:42:12Z`** / **`2026-03-27T22:12:58Z`**; **`HEAD`** unchanged **`55dc6a8bb28d`** (**Aligned**); includes **`docs/channels/`** in layout checks. (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
...
- **Tasks / docs** — Expanded **CLOSED** task notes under **`tasks/`** (browser/CDP health, SPA dwell, graceful shutdown, click fallbacks, in-page search, OpenClaw queue/debounce/draft/keyed queue, downloads, Ori Mnemos, CDP crash recovery, focused-tab screenshot, session timeout, managed-tab cap, diagnostics, scheduler main-session awareness, Discord reply-to-bot mention); WIP browser history forward/reload tool notes. **OpenClaw reviewer** — independent re-run **`2026-03-27T22:12:58Z`** (prior **`2026-03-27T21:44:46Z`** / **`2026-03-27T21:14:50Z`**), **`HEAD`** unchanged **`55dc6a8bb28d`** (**Aligned**). (`tasks/`, `005-openclaw-reviewer/005-openclaw-reviewer.md`.)
...
### Added
- **Session serialization (`keyed_queue`)** — Per-key async mutex so full agent turns (tool loops, browser work, session memory) for the same logical key (e.g. Discord channel) cannot interleave; different keys still run concurrently. (`src-tauri/src/keyed_queue.rs` and call sites.)
- **Protected `config.json` mutations** — `config/protected_mutation` refuses programmatic merges/writes when security-sensitive top-level keys would change (browser/tools toggles, SSRF lists, attachment roots, CDP surface, compaction/reset hooks, router budgets, heartbeat, etc.). (`src-tauri/src/config/protected_mutation.rs`, `config/mod.rs`.)
- **CDP example** — `example_com_history_reload_smoke.rs` for history/reload smoke coverage.

### Changed
- **Browser agent, commands, and runtime** — CDP stack (downloads, trace, DOM snapshot, credentials, URL filter, doctor, transport/tab vendor patches), Ollama/tool-loop/turn-lifecycle pipeline, scheduler and Discord integration, logging/redaction, metrics/feature-health/task runner, and related docs (Discord, scheduler, Ollama API, browser automation, feature health, logging subsystems, Ori lifecycle, router/agents, session memory).

## [0.1.64] - 2026-03-27

### Fixed
- **Browser agent (CDP) blank-tab focus drift** — When **`CURRENT_TAB_INDEX`** points at **`about:blank`** / Chrome new-tab surfaces but another tab still has a real URL (common after CDP reconnect), **`get_current_tab`** refocuses using the stored automation **TargetID**, then host match, then first non-ephemeral tab. **Info** log: `focused tab was blank/new-tab; refocused tab index …`. **`is_new_tab_or_blank`** now matches **`chrome://new-tab-page`** via **`is_new_tab_page_url`**. CDP post-attach readiness wait increased **8s → 15s**. **`BROWSER_HOVER` / `BROWSER_DRAG`** router args use the **first line only** so trailing `DONE:` on a second line parses. (`browser_agent/mod.rs`, `commands/browser_tool_dispatch.rs`, `docs/029_browser_automation.md`.)
- **Browser agent (CDP) empty-tab attach** — After WebSocket connect, **`wait_for_cdp_targets_ready_after_attach`** no longer requires at least one page tab before caching the session; it accepts a stable **zero-tab** list after one follow-up probe (~200 ms) so **`get_current_tab`** can run the existing **`about:blank`** bootstrap. Logs at **info** (`-vv`): `attach readiness OK with 0 page tabs (get_current_tab will bootstrap about:blank if needed)`. (`browser_agent/mod.rs`, `docs/029_browser_automation.md`.)
- **Single-instance `flock`** — The lock file handle is stored in a process-lifetime **`OnceLock`** so the exclusive lock is not released when `run_internal`’s setup block returns (previously a second process could start a full backend). (`lib.rs`.)
- **Agent router stale-batch guard** — After a page-changing action in a multi-tool turn, **`BROWSER_SCREENSHOT`** and **`BROWSER_SAVE_PDF`** still run (they capture the post-navigation page). Other browser tools in the same batch remain skipped to avoid stale element indices. Log text updated. (`commands/tool_loop.rs`, `docs/029_browser_automation.md`.)
- **BROWSER_SWITCH_TAB / BROWSER_CLOSE_TAB** — Parse the tab index from the **first whitespace-separated token** only so compound model lines (e.g. `0 BROWSER_CLOSE_TAB: 1` on one line) work; log when trailing text is ignored. (`commands/browser_tool_dispatch.rs`, `docs/029_browser_automation.md`.)

### Changed
- **`discord run-ollama` (CLI)** — Parses the same leading directives as Discord (`model:`, `skill:`, `agent:`, `temperature:`, `num_ctx:`, etc.) via `parse_discord_ollama_overrides`, so model override and catalog soft-validate paths are testable without Discord; logs `cli/run-ollama` when a preamble model or agent is set. `format_skill_not_found_error` / `extract_model_switch_from_question` / `parse_discord_ollama_overrides` are public on the `discord` module for reuse. (`src/main.rs`, `discord/mod.rs`, `docs/012_ollama_context_skills.md`.)
- **OpenClaw reviewer** — Independent re-run **`2026-03-27T09:24:24Z`** (`HEAD` unchanged **`55dc6a8bb28d`**); prior **`2026-03-27T08:22:01Z`** / **`2026-03-27T08:00:03Z`** / **`2026-03-27T07:43:04Z`** / **`2026-03-27T07:36:22Z`** / **`2026-03-27T07:29:54Z`** / **`2026-03-27T07:18:44Z`** / **`2026-03-27T07:11:14Z`** / **`2026-03-27T07:03:55Z`** / **`2026-03-27T06:50:52Z`** / **`2026-03-27T06:39:07Z`** / **`2026-03-27T06:32:32Z`** / **`2026-03-27T06:26:12Z`** / **`2026-03-27T06:19:58Z`** / **`2026-03-27T06:12:38Z`** / **`2026-03-27T06:05:58Z`** / **`2026-03-27T05:59:51Z`** / **`2026-03-27T05:53:27Z`** / **`2026-03-27T05:47:18Z`** / **`2026-03-27T05:34:45Z`** / **`2026-03-27T05:27:10Z`** / **`2026-03-27T05:16:03Z`** / **`2026-03-27T05:09:59Z`** / **`2026-03-27T05:03:25Z`** / **`2026-03-27T04:55:36Z`** / **`2026-03-27T04:47:34Z`** / **`2026-03-27T04:39:54Z`** / **`2026-03-27T04:28:24Z`** / **`2026-03-27T04:22:01Z`** / **`2026-03-27T04:15:50Z`** / **`2026-03-27T04:09:18Z`** / **`2026-03-27T03:52:19Z`** / **`2026-03-27T03:45:36Z`** / **`2026-03-27T03:39:16Z`** / **`2026-03-27T03:32:18Z`** / **`2026-03-27T03:26:00Z`** / **`2026-03-27T02:58:30Z`** / **`2026-03-27T02:52:06Z`** / **`2026-03-27T02:45:40Z`** / **`2026-03-27T02:38:43Z`** / **`2026-03-27T02:31:09Z`** / **`2026-03-27T02:23:48Z`** / **`2026-03-27T02:16:31Z`** / **`2026-03-27T02:08:55Z`** / **`2026-03-27T02:02:43Z`** / **`2026-03-27T01:56:14Z`** / **`2026-03-27T01:49:55Z`** / **`2026-03-27T01:43:29Z`** / **`2026-03-27T01:36:48Z`** / **`2026-03-27T01:30:49Z`** / **`2026-03-27T01:24:26Z`** / **`2026-03-27T01:17:18Z`** / **`2026-03-27T01:06:05Z`** / **`2026-03-27T00:54:29Z`** / **`2026-03-27T00:48:19Z`** / **`2026-03-27T00:40:31Z`** / **`2026-03-27T00:33:14Z`** / **`2026-03-27T00:26:44Z`** / **`2026-03-27T00:20:40Z`** / **`2026-03-27T00:09:18Z`** / **`2026-03-27T00:02:45Z`** / **`2026-03-26T23:56:30Z`** / **`2026-03-26T23:49:51Z`** / **`2026-03-26T23:43:28Z`** / **`2026-03-26T23:37:25Z`** / **`2026-03-26T23:31:13Z`** / **`2026-03-26T23:24:57Z`** / **`2026-03-26T23:18:54Z`** / **`2026-03-26T23:12:30Z`** / **`2026-03-26T23:05:57Z`** / **`2026-03-26T22:54:36Z`** / **`2026-03-26T22:48:32Z`** / **`2026-03-26T22:41:56Z`** / **`2026-03-26T22:35:16Z`** / **`2026-03-26T22:29:10Z`** / **`2026-03-26T22:23:07Z`** / **`2026-03-26T22:17:01Z`** / **`22:10:45Z`** / **`22:04:38Z`** / **`21:58:27Z`** / **`21:51:49Z`** / **`21:45:17Z`** / **`21:33:57Z`** / **`21:27:45Z`** / **`21:15:14Z`** / **`21:09:03Z`** / **`21:02:40Z`** / **`20:51:23Z`** / **`20:43:54Z`** / **`20:36:56Z`** / **`20:30:41Z`** / **`20:14:22Z`** / **`20:02:32Z`** / **`19:55:40Z`**; same checks (layout, `pnpm check` / `tsgo`, Vitest, §7 **Aligned**). (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)

## [0.1.63] - 2026-03-26

### Changed
- **OpenClaw reviewer** — Independent re-run **`2026-03-26T23:18:54Z`** (`HEAD` unchanged **`55dc6a8bb28d`**); prior **`2026-03-26T23:12:30Z`** / **`2026-03-26T23:05:57Z`** / **`2026-03-26T22:54:36Z`** / **`2026-03-26T22:48:32Z`** / **`2026-03-26T22:41:56Z`** / **`2026-03-26T22:35:16Z`** / **`2026-03-26T22:29:10Z`** / **`2026-03-26T22:23:07Z`** / **`2026-03-26T22:17:01Z`** / **`22:10:45Z`** / **`22:04:38Z`** / **`21:58:27Z`** / **`21:51:49Z`** / **`21:45:17Z`** / **`21:33:57Z`** / **`21:27:45Z`** / **`21:15:14Z`** / **`21:09:03Z`** / **`21:02:40Z`** / **`20:51:23Z`** / **`20:43:54Z`** / **`20:36:56Z`** / **`20:30:41Z`** / **`20:14:22Z`** / **`20:02:32Z`** / **`19:55:40Z`**; same checks (layout, `pnpm check` / `tsgo`, Vitest, §7 **Aligned**). (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)

## [0.1.62] - 2026-03-26

### Changed
- **OpenClaw reviewer** — Independent re-run **`2026-03-26T20:36:56Z`** (`HEAD` unchanged **`55dc6a8bb28d`**); prior **`2026-03-26T20:30:41Z`** / **`20:14:22Z`** / **`20:02:32Z`** / **`19:55:40Z`**; same checks (layout, `pnpm check` / `tsgo`, Vitest, §7 **Aligned**). (`005-openclaw-reviewer/005-openclaw-reviewer.md`.)
