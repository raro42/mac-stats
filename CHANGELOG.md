...
### Documentation
- **FEATURE-CODER backlog (FEAT-D41–D55)** — Table rows for completed FETCH_URL `clean_html` work: U+202A–U+202E bidi embedding/override, variation selectors (U+FE00–U+FE0F, U+E0100–U+E01EF) plus Mongolian U+1800–U+180E (FEAT-D50 consolidates prior U+1806/U+180A/U+180B–U+180E coverage), Unicode Tags U+E0000–U+E007F, Khmer inherent vowels U+17B4/U+17B5, Arabic/Syriac edition format controls U+0600–U+0605 / U+06DD / U+070F / U+08E2, FEAT-D47 (`<img>` alt/title → `[Image: …]`), FEAT-D48 (U+1361 / U+2800 / U+1BCA0–U+1BCA3), FEAT-D49 (Arabic Extended-A U+0890–U+0891), FEAT-D51 (U+13430–U+13438 / U+1D173–U+1D17A), FEAT-D52 (U+1BC9D–U+1BC9E / U+110BD / U+110CD), FEAT-D53 (U+1107F / U+2FF0–U+2FFB), FEAT-D54 (Egyptian hieroglyph format U+13430–U+13455), and FEAT-D55 (middle-dot punctuation U+00B7 / U+0387 / U+30FB / U+FF65). (`006-feature-coder/FEATURE-CODER.md`.)
