...
- **2026-09-26 (~21:45):** Monitors summary Avg None yet + settings empty identity (v0.1.1246). Recapture of `feature-monitors.png` deferred if Screen Recording TCC / no on-screen CPU window; prior Aug 14 asset kept; polish grace marked.
...
- **2026-09-15 (~20:00):** Agent Ops Overview empty calm (v0.1.1082). Recaptured `feature-agent-ops.png` (window-only, Agent Ops expanded via `MAC_STATS_OPEN_SECTION=agent-ops`).
- **2026-09-14 (~06:00):** Agent Ops filter-miss calm (v0.1.1073). Recapture of `feature-agent-ops.png` deferred (`screencapture -l` → could not create image / Screen Recording TCC); prior Aug 12 asset kept; polish grace marked.
