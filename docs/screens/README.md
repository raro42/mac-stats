...
- **2026-08-16 (evening):** Agent Ops Runs request-id click-to-copy chip (v0.1.471). Agents slug/id chip (v0.1.469). Runs click-to-preview (v0.1.468). Data Poster inactive icons (v0.1.470). Recapture of `feature-agent-ops.png` still deferred (`screencapture -l` → could not create image).
