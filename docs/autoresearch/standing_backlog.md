...
- Perplexity Search **collapsed keep-header** (header + last-search glance stay visible when collapsed; Ready · search / Last · query / Key · add API key; click expands) — **v0.1.556**
