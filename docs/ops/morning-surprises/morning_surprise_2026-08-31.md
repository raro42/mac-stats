...
Overnight Track B (20:00–06:00). Digester open stayed empty; design review in grace. Standing-backlog Credentials polish continued through **v0.1.767** (MCP). Daytime fixes **v0.1.761–762** repaired a blank CPU window and replaced the layout-shifting rings Hot bar with amber pulse.

## Shipped tonight

| Version | What |
|---------|------|
| **v0.1.767** | **Settings MCP server URL + stdio** — Credentials Save/Clear (Keychain `mcp_server_url` / `mcp_server_stdio`); **MCP · Not set · add URL or stdio** red strip; `/mcp` Not-set mentions Settings |
...
| **v0.1.755** | **Agent Ops Digest open attention glance** — amber **Digest · N open · …** strip under Fail/Slow when digester has open candidates |
| **v0.1.754** | **Perplexity Top/error attention glance** — **Search · error / N results · Top** above filters |
| **v0.1.753** | **Details Load/RAM Hot attention** — **Hot · Load · RAM** above Details grid |
| **v0.1.752** | **Debug Log Error/Warn attention** — **Logs · N errors · M warns** above toolbar |
| **v0.1.751** | **Power strip Hot attention** — Bat/LPM/Heat/Up/RAM/SSD under slim row |
| **v0.1.750** | **CPU rings Hot attention** — under gauges (later replaced by pulse in **v0.1.762**) |
| **v0.1.749** | **Disk Cleanup Reclaim/Due attention** |
| **v0.1.748** | **Monitors Down/Slow attention** |
| **v0.1.747** | **Top Processes Hot attention** |
| **v0.1.746** | **Agent Ops Runs Fail/Slow glance** |
| **v0.1.745** | **AI Chat Errors glance** |

## Tried / notes

- Digester open empty — no Slowest/latency fuel; used standing backlog (MCP Credentials after Mastodon).
...
- Installed **v0.1.767**; Discord Bot connected after kickstart.
...
- Sibling ports / p50 patterns / Telegram·Slack·Signal alert Ready in Credentials (channels are in-memory — need persist design) / screenshot recapture.
