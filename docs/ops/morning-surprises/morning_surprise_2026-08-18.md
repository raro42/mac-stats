...
- Recapture `docs/screens/feature-agent-ops.png` — Screen Recording TCC / no window id often blocks overnight capture. Aug 12 asset kept until a permitted shot.
