...
- Window-only recapture of `feature-monitors.png` / `feature-disk-cleanup.png` / `feature-processes.png` / `feature-ai-chat.png` (Screen Recording TCC / `screencapture -l`); polish grace marked when capture fails.
