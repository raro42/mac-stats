...
Overnight Track B (20:00–06:00 local, continuing from 2026-09-17 evening). Digester open empty. Design review not due. Soft-parity theme icon washes continue after apple + light.
...
Swiss-minimalistic section icons now match apple’s soft Ready / Slow·Down washes — status no longer shouts louder than the attention glances beside them.
...
- Soft-parity leftovers: material / data-poster / dark / neon / architect / futuristic still on older icon washes (~10%/22% or ~12%/28%); prefer digester / design-review / sibling Hermes/OpenClaw ports with clear user fitness when those are quieter
