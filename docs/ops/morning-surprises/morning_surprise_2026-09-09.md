...
| Version | What |
|---------|------|
| **v0.1.958** | Instant lane: prompts directory age (`prompts age` / how-old asks → newest `~/.mac-stats/agents/prompts/` mtime; path/size/planning·execution ages safe) |
...
## Latest tick (~03:45)
- Fuel: standing backlog p50 (design-review already used this night @ v0.1.942).
- Keep — prompts directory age instant lane (v0.1.958).
