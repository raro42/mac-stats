...
- Next calm: Heat Nominal strip calm if reintroduced; SSD strip calm if reintroduced; sibling Hermes/OpenClaw ports with clear user fitness; digester open when present
