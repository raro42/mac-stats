...
Overnight Track B (20:00–06:00 local). Digester open stayed empty most ticks. Standing backlog drove filter-miss calm, a take-note latency fix, Details / Top Processes / Disk Cleanup / Debug Log / Perplexity glance calm, Temp · CPU · GPU · FREQ ring calm, battery · LPM · Power · time-remaining calm, Disk Cleanup meta-card calm, AI Chat last-answer / turn / model-online / Ready glance calm, Discord idle-thought 503 retry from tonight’s debug.log, then good-news filter-miss soft parity, then accent filter-miss soft parity, then power-strip calm soft parity, then Settings Help open calm soft parity, then Chat last-answer attention soft parity.

## Shipped

| Version | What |
|---------|------|
| **v0.1.1114** | Chat last-answer attention soft parity — Chat · Last answer glance soft green at 7% / 28% border (Ready calm / chat-answer soft parity); louder 8%/32% tint removed |
| **v0.1.1113** | Settings Help open calm soft parity — Help · Open glance soft green at 7% / 28% border (Ready calm / Monitors all-up); louder 10%/38% tint removed |
| **v0.1.1112** | Power-strip calm soft parity — battery / LPM Off / Power low-draw / time-remaining (≥2h) soft green at 7% (Ready calm / Monitors all-up); louder 10% tint removed |
| **v0.1.1111** | Accent filter-miss soft parity — Up / Pinned / Top / Snippet / Clean / On / You / Assistant / Ops calm empties soft accent at 7% (Ready calm / good-news soft parity); louder 10% tint removed |
...
- Next calm: Disk Cleanup due attention soft parity (8%→7%); Ops On/Live/Jobs/Core/Instant/Lite/Direct filter attention soft parity (8%→7%); Heat Nominal strip calm if reintroduced; SSD strip calm if reintroduced; sibling Hermes/OpenClaw ports with clear user fitness; digester open when present
