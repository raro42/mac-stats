...
- Next calm: chat last-answer attention soft parity (8%→7%); Disk Cleanup due attention soft parity (8%→7%); Heat Nominal strip calm if reintroduced; SSD strip calm if reintroduced; sibling Hermes/OpenClaw ports with clear user fitness; digester open when present
