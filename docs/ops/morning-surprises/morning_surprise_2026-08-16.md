...
- After design-review keeps + Load flash, tick picked Settings Reset busy-guard (non-Agent-Ops-adjacent).
- Install/kickstart: Discord Ready (Werner_Amvara) on 0.1.433.
