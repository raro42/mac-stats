...
| Discord | Bot token present (env / `.config.env` / Keychain); gateway received `Ready` |
...
- `src-tauri/src/discord/mod.rs` — `discord_bot_token_configured()`, `discord_bot_gateway_ready()`
