...
**Upstream status:** `../openclaw/AGENTS.md` matches `package.json`, `vitest.config.ts`, and `src/` as of 2026-03-26 (`55dc6a8bb2`; last check `2026-03-26T08:11:53Z`).
